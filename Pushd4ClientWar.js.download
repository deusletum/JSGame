 ...
 * @constructor
 */
nxg.Pushd4Client = function (servers, networkIdent, applicationId, userId, authToken, options) {
	this._socket = null;
	this._ping = null;
...
nxg.Pushd4Client.prototype._setStatus = function (newStatus) {
...
nxg.Pushd4Client.prototype._send = function (message) {
...
nxg.Pushd4Client.prototype.connect = function () {
	...
	var isFlashSocket = ~~window.WebSocket.loadFlashPolicyFile;
...
nxg.Pushd4Client.prototype._receive = function (message) {
...
nxg.Pushd4Client.prototype._authResponse = function (message) {
	var self = this;
...
nxg.Pushd4Client.prototype._messageResponse = function (message) {
...
nxg.Pushd4Client.prototype.emit = function (event, data) {
...
nxg.Pushd4Client.prototype.on = function (event, cb) {
	if (!this._handlers[event])
...
nxg.Pushd4Client.prototype.flashEmit = function (event, parameters) {
