...
*/
  ...
  function u(a, b, c) {
    if (b)
      a: {
        ...
        null != b &&
          (a
            ? l(q, d, { configurable: !0, writable: !0, value: b })
            : b !== c &&
              ((r[d] = ca ? n.Symbol(d) : "$jscp$" + d),
              (d = r[d]),
              l(f, d, { configurable: !0, writable: !0, value: b })));
      }
  }
  u(
  ...
  function ra(a, b) {
    a.src =
      b instanceof la && b.constructor === la
        ? b.a
        : "type_error:TrustedResourceUrl";
    (b = a.ownerDocument && a.ownerDocument.defaultView) && b != x
      ? (b = ha(b.document))
      : (null === y && (y = ha(x.document)), (b = y));
  ...
  var wa = /[?&]($|#)/;
  function F(a, b, c) {
    for (var d = a.search(D), e = 0, f, g = []; 0 <= (f = C(a, e, b, d)); )
  ...
  var Ma = { s: 2, D: 13, C: 14, v: 16, u: 17 },
    J = null;
  function Na() {
  ...
  function ab(a) {
    function b() {
      for (var e = 0; e < c.length; e++) if (!Ya(c[e])) return !0;
      return !1;
    }
    var c = ["ad_storage"];
    if (b()) {
  ...
  function eb(a, b) {
    ...
    if ("protocol" === c || "port" === c)
      a.protocol = fb(a.protocol) || fb(L.location.protocol);
    "port" === c
      ? (a.port = String(
  ...
  function jb(a, b, c) {
    ...
    if (hb(c.c)) {
      if (void 0 == b)
        ...
        c.encode && (b = encodeURIComponent(b)), (b = kb(b)), (f = a + "=" + b);
      var g = {};
      f = d(f, "path", c.path);
      ...
      if ("auto" === k) {
        ...
        k && "none" !== k && (f = d(f, "domain", k)),
          (f = e(f, c.flags)),
          mb(k, c.path) || ib(f, a, b, c.c);
    }
  }
  function kb(a) {
  ...
  var qb = /^\w+$/,
    rb = /^[\w-]+$/,
    sb = /^~?[\w-]+$/,
    tb = { aw: "_aw", dc: "_dc", gf: "_gf", ha: "_ha", gp: "_gp" };
  function ub() {
  ...
  function Eb() {
    for (
      var a = ["aw"], b = {}, c = zb(b.prefix), d = {}, e = 0;
      e < a.length;
      e++
    )
      tb[a[e]] && (d[a[e]] = tb[a[e]]);
  ...
  function Kb(a, b) {
    if (Hb.test(a.location.host)) {
      if ((a = a.location.href.match(Jb)) && 2 == a.length && a[1].match(Gb))
        return a[1];
    } else if (((a = wb(a, (b || "_gcl") + "_aw")), 0 < a.length))
      return a.join(".");
    return "";
  }
  function Lb(a) {
    0 !== wb(document, "_gcl_aw").length ||
      (a && 0 !== wb(document, a + "_aw").length) ||
      (Cb(), Eb());
  }
  function Mb(a) {
    var b = x.performance;
  ...
  function Qb(a, b) {
    b.google_tag_manager &&
      ...
      ((b = b.google_tag_manager._li), S(a, 4, b.cbt), S(a, 3, b.cst));
  }
  function Rb() {
    var a = R.a();
  ...
  function lc(a, b) {
    ...
    if (
      ...
      return (c = Kb(a, b.google_gcl_cookie_prefix)), V("gclaw", c);
    (b = Kb(a)) && (c = V("gclaw", b));
    if (Hb.test(a.location.host))
      var d =
        (d = a.location.href.match(Ib)) && 2 == d.length && d[1].match(Fb)
  ...
  function pc(a, b, c, d, e, f) {
    ...
    switch (e) {
      ...
      case 0:
        ...
        break;
      case 4:
        (h = "www.google.com/"), (m = "pagead/privacysandbox/conversion/");
    }
    ...
    a = [
      ...
      fc(d.google_tag_for_child_directed_treatment),
      gc(d.google_tag_for_under_age_of_consent),
      hc(d.google_allow_ad_personalization_signals),
      ...
      ec(d, f),
      lc(c, d),
      oc(a, c, d.google_conversion_page_url, d.google_conversion_referrer_url),
      nc(c),
      rc(d.google_additional_params),
      rc(
  ...
  function Bc(a, b) {
    a.onload_callback && "function" == typeof a.onload_callback.call
      ? (a.onload_callback = ac(b, a.onload_callback))
    ...
    try {
      if (xc(d)) {
        d.google_remarketing_only &&
          ...
          !Xb &&
          J &&
          I(["376635470", "376635471"], Ca, 2);
        d.google_remarketing_only &&
          !d.google_conversion_domain &&
          J &&
          I(["759238990", "759238991"], Fa, 13);
        !d.google_remarketing_only ||
          d.google_conversion_domain ||
          (J && ("759248991" == K(14) || "759248990" == K(14))) ||
          (J && I(["759248990", "759248991"], Ea, 14));
        !1 === d.google_conversion_linker ||
          d.google_gtm ||
          Lb(d.google_gcl_cookie_prefix);
        if (
          ...
          g = function () {
            ...
            if (h && h.capi && !d.google_transport_url) {
              if ((h = !Ac)) {
                h = c;
                var m = t("www.googleadservices.com", "endsWith").call(
                  "www.googleadservices.com",
                  "google.com"
                )
                  ? ""
              ...
              h
                ...
                : ((Ac = !0),
                  (h =
                    (h = c.featurePolicy) && "function" === typeof h.features
                      ? 0 <= h.features().indexOf("conversion-measurement")
                      : !1));
            } else h = !1;
            h && vc(a, c, d, pc(a, b, c, d, 4), !1, !1);
          };
          var k = function (h) {
            vc(a, c, d, pc(a, b, c, d, h), !0, !0);
          };
          d.google_remarketing_only
            ? k(2)
            : f
  ...
  function Ec(a, b, c) {
    ...
    if (2 == c.length) {
      var g = c[0],
        k = c[1];
      0 <= C(g, 0, "rmt_tld", g.search(D)) &&
        0 <= C(g, 0, "ipr", g.search(D)) &&
        !k.match(ua)[6] &&
        ((k += va(g)), (c[1] = F(k, "rmt_tld", "1")));
    }
    for (g = 0; g < c.length; g++) {
      ...
      switch (parseInt(h, 10)) {
        case 1:
        case 2:
          (h = a.document.getElementById("goog_conv_iframe")) && !h.src
            ? ((h.onload = e), (h.src = k))
            : d(e, k);
          break;
        case 4:
