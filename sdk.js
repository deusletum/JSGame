/*1605032705,,JIT Construction: v1002950608,en_US*/
        ...
        with (this) {
              ...
              a = b("Type").extend(
                {
                  constructor: function (a) {
                    ...
                    var b = {},
                      c = this;
                    ES(ES("Object", "keys", !1, a), "forEach", !0, function (
                      d
                    ) {
                      (b[d] = a[d]),
                        (c["set" + d] = function (a) {
          ...
          __d(
            ...
            function (a, b, c, d, e, f) {
              ...
              function a(a, c, d, e) {
                ...
                c != "post" &&
                  ((a = b("QueryString").appendToUrl(a, d)), (d = ""));
                c = i(c, a);
                if (!c) return !1;
            ...
            function (a, b, c, d, e, f) {
              ...
              function g(a) {
                ...
                if (
                  ...
                  f &&
                    f.length < e.length &&
                    ((a.payload = f), (d = b("QueryString").appendToUrl(c, a)));
                }
                h(c, d, a);
              }
              function h(a, c, d) {
            ...
            function (a, b, c, d, e, f) {
              ...
              function s(a, c, d) {
                ...
                i =
                  (f === "unknown" && a != null) ||
                  (b("sdk.Runtime").getUseCookie() &&
                    b("sdk.Runtime").getCookieUserID() !== g);
                      ...
                      ES("JSON", "stringify", !1, {
                        ...
                        expiresAt:
                          a != null && a.expiresIn && a.expiresIn !== 0
                            ? ES("Date", "now", !1) +
                              Math.min(a.expiresIn * 0.75 * 1e3, k)
                            : ES("Date", "now", !1) + l,
                      })
                    );
                }
                ...
                return function (d) {
                  if (d && d.access_token) {
                    ...
                    d && d.asset_scopes
                      ...
                      ? (A(), (f = "unknown"), s(null, f))
                      : d && d.result && (z(), (c = d.result.authResponse));
                  if (a) {
                    f = {
                      authResponse: c,
                      status: b("sdk.Runtime").getLoginStatus(),
              ...
              function C(a, c) {
                ...
                window.removeEventListener("fbNativeLoginResponse", function (
                  b
                ) {
              ...
              function D(a) {
                  ...
                  if (f !== "") {
                    ...
                    if (window == top && d != null) {
                      ...
                      a = function (a) {
                        ...
                        a != null &&
                          a.status === "connected" &&
                          ((c = a.authResponse) == null
                            ? void 0
                            : c.accessToken) === d &&
                          (delete h.access_token,
                          delete h.code,
                          delete h.signed_request,
                          (location.hash = b("QueryString").encode(h)),
                          j != null &&
                            a.authResponse != null &&
                            (a.authResponse.signedRequest = j));
                        k != null && k(a);
                      };
                    }
                  }
                ...
                if (
                  ...
                  window.addEventListener("fbNativeLoginResponse", function (
                    b
                  ) {
                    return C(a, b.response);
                  });
                ...
                } else r.getLoginStatusCORS(a, l, p);
              }
              function E(a) {
                a = new (b("sdk.URI"))(
                  b("UrlMap").resolve("www").replace("web.", "www.") +
                ...
                switch (c) {
                  case "connected":
                    ...
                    d.data_access_expiration_time != null &&
                      (e.data_access_expiration_time = Number(
              ...
              function G(c, d, a) {
                d === 0
                  ...
                  : (b("sdk.Scribe").log("jssdk_error", {
                    ...
                    b("Log").error(
                      "Error retrieving login status, HTTP status code: " + d
                    ));
                if (c) {
                  d = {
                    authResponse: a,
                    ...
                    (d.onreadystatechange = function () {
                      if (d.readyState === 4) {
                        ...
                        if (d.status === 200) {
                          F(
                            c,
                            (f = d.getResponseHeader("fb-s")) != null
                              ? f
                              : "unknown",
                            (f = d.getResponseHeader("fb-ar")) != null
                              ? f
                              : "{}"
                          );
                        } else G(c, d.status, a);
              ...
              var g = {
                ...
                _updateRecipients: function () {
                  (g._allowedRecipients = {}),
                    b("sdk.api")("/me/apprequestformerrecipients", function (
                      a
                    ) {
                      if (!a || a.error) return;
              ...
              var n = {
                ...
                prepareCall: function (a, c) {
                  ...
                  g = {
                    ...
                    url:
                      b("UrlMap").resolve(a.display == "touch" ? "m" : "www") +
                      "/" +
                      e.url,
                    params: a,
                    name: d,
                ...
                popup: function (a) {
                  ...
                  a.post
                    ...
                    : ((g = window.open(a.url, a.id, f)),
                      g && n.setLoadedNode(a, g, "popup"));
                  if (!g) {
                ...
                _popupMonitor: function () {
                  ...
                  for (var c in n._loadedNodes)
                    if (
                      Object.prototype.hasOwnProperty.call(n._loadedNodes, c) &&
                      c in n._defaultCb
                    ) {
                      var d = (function () {
                            ...
                            ? d.method === "permissions.oauth"
                              ? b("sdk.Auth").getLoginStatus(function (a) {
                                  ...
                                  d.params.return_scopes
                                    ? b("sdk.api")("/me/permissions", function (
                                        b
                                      ) {
                                        (!b || b.error) &&
                  ...
                  a && !n._popupInterval
                    ? (n._popupInterval = window.setInterval(
                        n._popupMonitor,
                        100
                      ))
                    : !a &&
                      n._popupInterval &&
                      (window.clearInterval(n._popupInterval),
          ...
          __d(
            ...
            function (a, b, c, d, e, f) {
              ...
              b("sdk.RPC").local.showFlashObjects = b(
                "sdk.RPC"
              ).local.showPluginObjects;
              b("sdk.RPC").local.hideFlashObjects = b(
                "sdk.RPC"
          ...
          __d(
            ...
            function (a, b, c, d, e, f) {
              ...
              if (h) {
                ...
                c = null;
                d = ES(g.getEntriesByType("resource"), "filter", !0, function (
                  a
                ) {
          ...
          __d(
            ...
            function (a, b, c, d, e, f) {
              ...
              function m(a) {
                return (
                  g[k(a, "nodeName").toLowerCase()] || g[l(a).toLowerCase()]
                );
              }
              function n(a) {
                var b = ES(
                  k(a, "className").split(/\s+/),
                  "filter",
                  !0,
                  function (a) {
          ...
          __d(
            ...
            function (a, b, c, d, e, f) {
              ...
              b("XFBML").subscribe(
                "parse",
                ES((a = b("sdk.Event")).fire, "bind", !0, a, "xfbml.parse")
              );
              b("XFBML").subscribe(
                "render",
                ES(a.fire, "bind", !0, a, "xfbml.render")
              );
              ...
              function i(a, c) {
                ...
                if (!c.href) {
                  ...
                  d ||
                    ...
                    d &&
                      ES(d, "indexOf", !0, "#") > 0 &&
                      (d = d.substring(0, ES(d, "indexOf", !0, "#"))));
                  d && (c.fb_comment_id = d);
                }
              ...
              a = b("IframePlugin").extend({
                constructor: function (a, c, d, e) {
                  ...
                  this.subscribe("xd.login_button_dialog_open", function (a) {
                    b("sdk.ui")(ES("JSON", "parse", !1, a.params), function (
                      a
                    ) {
                      b("sdk.XD").sendToFacebook(l, {
                        method: "loginComplete",
            ...
            function (a, b, c, d, e, f) {
              ...
              function r(a) {
                ...
                (g || (g = b("UnicodeUtils"))).strlen(k) > c
                  ? (k =
                      (g || (g = b("UnicodeUtils"))).substr(k, 0, c - 3) +
                      "...")
  ...
  new Image().src =
    ...
    encodeURIComponent(
      '{"error":"LOAD", "extra": {"name":"' +
        ...
        '","revision":"1002950608","namespace":"FB","message":"' +
        e.message +
        '"}}'
    );
}
