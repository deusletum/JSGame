(function (m, t, A) {
  ...
  function Sb(a, b, c, d, f) {
    ...
    function F(a) {
      ...
      a: {
        ...
        for (var H = 0; H < z.length; H++)
          if (
            (!z[H].id || "string" != typeof z[H].id) &&
            v.calcAttribChecksum(z[H]) == F &&
            v.calcTextChecksum(z[H]) == k
          ) {
            z = !0;
            break a;
          }
    ...
    function q(a, e, b, c, k, d) {
      for (var f; b && (f = v.getElementSize(b)) && (!f[0] || !f[1]); )
        b = v.getElementParent(b);
      if (!b) return null;
      f = b[X];
    ...
    function e(a, e) {
      ...
      if (0 == e.length) var c = (b = "");
        ...
        100 >= e.length
          ? ((b = e), (c = ""))
          : 200 >= e.length
          ? ((b = e.substr(0, 100)), (c = e.substr(100)))
          : ((b = e.substr(0, 97)), (c = e.substr(e.length - 97)));
      var k = [];
    ...
    function Ua(a) {
      ...
      for (
        var k = -1, d = a.form.elements, g = d.length, f = 0, q = 0;
        f < g;
        f++
      )
        if (d[f].name == a.name) {
    ...
    function ra(a, e) {
      ...
      e &&
        ...
        (b =
          b ||
          !!v.getElementsByClassName("(ym-disable-keys|-metrika-nokeys)", a)
            .length);
      return b;
    }
    function A(a) {
          ...
          if (e[X]) u(e);
            ...
            if (b) {
              ...
              for (var c = b.length, k = 0; k < c; k++)
                /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(b[k].tagName) &&
                  !b[k][X] &&
                  u(b[k]);
            } else u(e);
          }
    ...
    function na(a) {
      ...
      var e = "password" === a.type || sa.test(a.name) || sa.test(a.id),
        b =
          h.reduce(
            function (e, b) {
    ...
    function E(a, e, b) {
      ...
      var c = na(a);
      c.ignore ||
        (!c.forceRecord && ((c.isPrivate && f.get("isEU")) || ra(a))) ||
        (u(a), ba(k, [x.nowEventTime(), e, b, a, c.privateFlag]));
    }
    function P(a) {
      var e = a.keyCode,
        b = sb(a);
      ...
      if ("string" == typeof b) {
        ...
        if (c) {
          ...
          for (var k = 0; k < c.length && !a; )
            (a = na(c[k]).privateFlag || ra(c[k], !0)), k++;
          b != gb &&
            ((gb = b),
            (b = a
              ? h
        ...
        if (a[X]) u(a);
          ...
          if (e) {
            ...
            for (var b = e.length, c = 0; c < b; c++)
              /^INPUT|SELECT|TEXTAREA|BUTTON$/.test(e[c].tagName) &&
                !e[c][X] &&
                u(e[c]);
          } else u(a);
        }
    ...
    function J(a) {
      if ((a = U.getTarget(a)) && !A(a) && "FORM" == a.nodeName) {
        for (var e = a.elements, b = 0; b < e.length; b++)
          v.isEmptyField(e[b]) || u(e[b]);
    ...
    var O = new tb({
        ...
        globalConfig: f,
        counterType: c,
        meta: { url: M().href, hitId: d, timezone: hb, timestamp: ib },
      }),
      Fa = {
        A: 1,
        ABBR: 2,
    ...
    if (!h.isMetrikaPlayer()) {
      ...
      t.attachEvent && !m.opera
        ? (w.on(t, "focusin", D), w.on(t, "focusout", I))
        : (w.on(m, "focus", Q), w.on(m, "blur", C), w.on(t, "blur", C));
      t.addEventListener
        ? (w.on(t, "focus", R),
          w.on(t, "blur", K),
          w.on(t, "change", L),
        ...
        : t.attachEvent &&
          ...
          (function () {
            for (
              var a = t.getElementsByTagName("form"), e = 0;
              e < a.length;
              e++
            ) {
              for (
                var b = a[e].getElementsByTagName("*"), c = 0;
                c < b.length;
                c++
              )
        ...
        if (a.length)
          for (var e = 0; e < a.length; e++) {
            ...
            if (
              "function" == typeof b ||
              ("object" == typeof b &&
                /^\s*function submit\(\)/.test(String(b)))
            )
              (a[e][Va] = b),
                (a[e].submit = function () {
                  J({ target: this });
            ...
            (function () {
              for (
                ...
                for (
                  ...
                  /^INPUT|SELECT|TEXTAREA$/.test(b[c].tagName) &&
                    w.un(b[c], "change", L);
                w.un(a[e], "submit", J);
              }
            })());
    ...
    if ("object" == typeof m.chrome && m.chrome.loadTimes) {
      if (
        ...
        b.requestTime &&
          b.firstPaintTime &&
          m.performance &&
          m.performance.timing)
      )
        return Math.round(
          1e3 * b.firstPaintTime - m.performance.timing.navigationStart
        );
    } else if (
      m.performance &&
      m.performance.timing &&
      ((b = m.performance.timing), b.navigationStart && b.msFirstPaint)
    )
    ...
    if (xb)
      var Zb = (function (a) {
        ...
        function (a, b, c) {
          ...
          var r = c(2),
            ...
            F = {
              ...
              toArray: function (a) {
                return a instanceof g.List || a instanceof n.KeyValue
                  ? (p && a instanceof p) || (y && a instanceof y)
                    ? Object(l.a)(a)
                    : a.toArray()
                  : Object(l.a)(a);
              },
              ...
              map: function (a, b) {
                ...
                for (var c = [], k = 0; k < e.length; k++) c[k] = b(e[k], k, e);
                return c;
              },
              find: function (a, b) {
              ...
              includes: function (a, b, e) {
                void 0 === e && (e = 0);
                if (
                  r.ObjectUtils.isNative(Array.prototype.includes, "includes")
                )
          ...
          var n = {
            ...
            findNativeImplementation: function (a) {
              ...
              for (var c = 0; c < b.length; c++) {
                var d = "" + b[c] + a;
                if (this.isNative(f.a[d], d)) return f.a[d];
              }
              return null;
            },
            ...
            objectIsWindow: function (a) {
              return (
                "undefined" !== typeof Window && a && a.window && a.window === a
              );
            },
          };
        },
        function (a, b, c) {
          ...
          "undefined" === g.a.WV_DEBUG &&
            Object.defineProperty(g.a, "WV_DEBUG", { value: {} });
          var y = (function () {
              var a = !1,
                b = !1;
          ...
          Object(a.a)(
            ...
            function (a) {
              var b,
                e = r[a] instanceof n.a.Function;
              p[a] = y
                ? e
                  ? (b = r[a]).bind.apply(b, [r].concat(F))
                  : r[a]
                : e
                ? function () {}
                : r[a];
        ...
        function (a, b, c) {
          ...
          try {
            var n = /Android|webOS|iPhone|iPad|iPod|BlackBerry|Windows Phone/i.test(
              navigator.userAgent
            )
              ? !0
              : !1;
        ...
        function (a, b, c) {
          ...
          var g = c(0);
          c = l.a.Set;
          a = a.ObjectUtils.isMonkeyPatchedOrUndefined(
            "Set",
          ...
          var n = (function () {
            function a(b) {
              ...
              b &&
                (b instanceof a
                  ? this.create(g.IterableUtils.toArray(b))
        ...
        function (a, b, c) {
          ...
          b.a = (function () {
            ...
            if ("undefined" !== typeof t && t.body) {
              ...
              b.contentWindow &&
                (b.contentWindow.toJSON = function () {
                  return A;
                });
              try {
                /Trident|MSIE/.test(navigator.userAgent)
                  ? t.body.parentNode && t.body.parentNode.appendChild(b)
          ...
          var d = c(4),
            ...
            n = {
              ...
              getScroll: function (a) {
                ...
                if (a.window === a)
                  return { top: a.scrollY || 0, left: a.scrollX || 0 };
              ...
              scrollingElement: function (a) {
                ...
                return (
                  a.scrollingElement ||
                  (a.documentElement.scrollHeight >= a.body.scrollHeight &&
                  0 === a.compatMode.indexOf("CSS1")
                    ? a.documentElement
                    : a.body)
                );
              },
              convertNode: function (a, b, c) {
                var d = void 0 === c ? { doc: t, saveChildren: !0 } : c;
                c = d.doc;
                d = d.saveChildren;
                c = c || a.ownerDocument;
                ...
                d &&
                  f.IterableUtils.forof(a.childNodes, function (a) {
              ...
              isBlankOrSameOriginIframe: function (a, b) {
                ...
                return (d && !d.match(/allow-same-origin/)) ||
                  (c &&
                    "about:blank" !== c &&
                    (c = g.StringUtils.parseURLNative(c).host) &&
                    (b || m).location.host !== c)
                  ? !1
                  : !0;
              },
              nodeIsRecordable: function (a) {
                if (null !== a) {
                  var b =
                      null != a.getAttribute("metrika-ignore") ||
                      /-metrika-ignore/.test(a.className),
                    c =
                      null != a.getAttribute("metrika-force") ||
                      /-metrika-force/.test(a.className);
              ...
              offsets: function (a, b) {
                ...
                c = c.excludePadding;
                var k = void 0 === c ? !1 : c;
                !1 === "getBoundingClientRect" in a &&
                  ("documentElement" in a
                    ? (a = a.documentElement)
                    : "document" in a && (a = a.document.documentElement));
              ...
              isHiddenContent: function (a) {
                ...
                return b &&
                  (/ym-show-content/.test(a.className) ||
        ...
        function (a, b, c) {
          ...
          var p = c.IGNORED_NODES,
            ...
            z = function (a) {
              ...
              a = a.nodeType;
              return (
                a === n.DOMUtils.NodeTypes.TEXT_NODE ||
                a === n.DOMUtils.NodeTypes.COMMENT_NODE
              );
            },
            h = function na(a, b) {
              var e = [];
            ...
            Ma = function (a, b) {
              var e = [];
              a &&
                (n.DOMUtils.nodeIsInTree(a)
                  ? m(
                      null == a ? t.documentElement : a,
                      function (a) {
                        e.push(a);
                      },
                      b
                    )
                  : e.push.apply(e, h(a, b)));
              return e;
            },
            Na = (function (a) {
              var b = a["*"],
              ...
              g.IterableUtils.forin(e, function (a) {
                var k,
                  d = (k = []).concat.apply(k, e[a].concat(b));
              ...
              return function (a, b) {
                if (a && b) {
                  ...
                  if (e)
                    return (
                      ((e = c[e.toLowerCase()]) && !!b.match(e)) || !!b.match(k)
                    );
                }
                return !1;
              };
              ...
              if (G(a, b, c)) {
                k = e.reduce(function (e, c) {
                  try {
                    ...
                    return y["default"].warn("Filtering error", ca), e;
                  }
                }, k);
                if ("string" === typeof k)
                  return (c = B[b]) ? c(a, b, k) || k : k;
            ...
            v = function (a, b, e) {
              if (e && e.name) {
                if (!1 !== u(b, e.name))
                  try {
                    var c,
                      k = ba(a, e.name, e.value);
                    return (c = {}), (c[e.name] = k || ""), c;
                  } catch (P) {
                    y["default"].warn("Error while reading attribute", e, a),
                      y["default"].warn(P);
                  }
          ...
          c = {
            ...
            getAttributes: function (a) {
              ...
              c &&
                c.length &&
                (g.IterableUtils.fastIterate(c, function (c, k) {
                  var d = v(a, e, k);
                  d && l.ObjectUtils.assign(b, d);
                }),
                (c = k[e] || A) &&
                  g.IterableUtils.fastIterate(c, function (c, k) {
                    v(b, e, { name: k, value: a[k] });
                  }));
        ...
        function (a, b, c) {
          ...
          var n = (function () {
            ...
            b.set = function (a, b) {
              ...
              -1 !== c
                ? (this.list[c].value = b)
                : ((this.list[this.lastIndex] = { key: a, value: b }),
            ...
            b["delete"] = function (a) {
              if ((a = this.find(a)))
                if (((a = this.indexOf(this.list, a)), -1 !== a))
                  return (
            ...
            var d = c(8),
              ...
              r = (function () {
                function b(b, c) {
                  ...
                  k = k.expose;
                  k = void 0 === k ? !1 : k;
                  this.allowedEvents = g.IterableUtils.toList(
                    (this.eventsList || b || []).map(function (a) {
                      return a.split(":")[0];
                    })
                  );
                  this.context = e || this;
                  this._define("_events", new a())
                    ._define("_memory", new a())
                    ._define("_namespaces", new a())
                    ._define("_options", new a())
                    ._define("_once", new a());
                  this._setupEvents();
                ...
                c._invokeEvent = function (a, b, c) {
                  ...
                  if ((a = this._getNamespace(k, a)) && 0 < a.size) {
                    ...
                    g.IterableUtils.forof(a, function (a) {
                      ...
                      q = q.then(function (g) {
                        return !1 !== g
                          ? ((g = e._runCallback(k, a, b)), c(g), d ? g : null)
                          : !1;
                      });
                    });
                  }
                ...
                c._saveMemory = function (a, b) {
                  return this._hasOption(a, "memory")
                    ? this._memory.has(a)
                      ? this._memory.get(a) || []
                      : this._memory.set(a, b) && b
                    : b;
                };
                ...
                c._setupEvents = function () {
                  ...
                  this.allowedEvents.size &&
                    g.IterableUtils.forof(this.allowedEvents, function (b) {
                      var c = b.split(":");
                      b = c[0];
                      c = c.slice(1);
                ...
                c._removeEvent = function (a, b) {
                  ...
                  g.has(b)
                    ? (c || g["delete"](b), this._removeNamespace(e, c, b))
                    : (c ||
                        (this._events["delete"](e), this._options["delete"](e)),
                ...
                c._removeNamespace = function (a, b) {
                  ...
                  e &&
                    (b
                      ? (this._removeCallbacks(a, e.get(b)), e["delete"](b))
                      : (g.IterableUtils.forof(e, function (b) {
        ...
        function (a, b, c) {
          ...
          (function (a) {
            ...
            var d = c(4),
              ...
              g = c(2),
              n = c(3),
              r = { null: null, undefined: A, true: !0, false: !1 },
              y = {
                delay: function (b, c) {
                  void 0 === c && (c = 0);
                ...
                copyText: function (b) {
                  return new a(function (a) {
                    ...
                    c.onselect = function () {
                      try {
                        (c.onselect = null),
                          t.execCommand && t.execCommand("copy"),
                          a();
                      } catch (e) {
                ...
                globalize: function (a, b) {
                  "undefined" !== typeof d.a &&
                    Object.defineProperty(d.a, b, { value: a });
                },
                guid: function () {
                  var a = function () {
                ...
                requestAnimationFrame: function (a) {
                  var b = g.ObjectUtils.findNativeImplementation(
                  ...
                  if (b && c)
                    return (
                      (this.requestAnimationFrame = b.bind(m)),
                ...
                cancelAnimationFrame: function (a) {
                  ...
                  b && c
                    ? ((this.cancelAnimationFrame = c.bind(m)),
                      this.cancelAnimationFrame(a))
                ...
                errorProxy: function (a, b, c) {
                  ...
                  try {
                    ...
                    return (
                      m.console.warn("Error while running " + (c || a.name), k),
                      b
                    );
                  }
                },
          ...
          var n = new RegExp("(" + c.join("|") + ")", "i"),
            ...
            p = {
              ...
              isValidNode: function (a) {
                ...
                return "INPUT" === b
                  ? !a || p.isValidType(a)
                  : /textarea|select|progress/i.test(b);
              },
              isPrivateInformationField: function (a) {
                var b = a.placeholder;
                return (
                  [a.className, a.id, a.name].reduce(function (a, b) {
                    return a || n.test(b);
                  }, !1) || r.test(b)
                );
              },
              isIgnored: function (a) {
                return /password/i.test(a.type) ||
                  /ym-disable-keys/i.test(a.className) ||
                  d.DOMUtils.isHiddenContent(a)
                  ? !0
                  : !1;
              },
              isRecordable: function (a) {
                return this.matchesClass(a.className, "ym-record-keys")
                  ? !0
                  : !1;
              },
          ...
          var d = c(4),
            ...
            l = {
              ...
              pad: function (a, b, c, d) {
                ...
                void 0 === d && (d = !1);
                a = String(a);
                b = f.IterableUtils.fill(
                  Array(Math.max(0, Math.min(b - a.length, b))),
                  c
                );
              ...
              stringToBlobURL: function (a, b, c) {
                ...
                var g = (function () {
                  ...
                  f = (function (a) {
                    return a
                      ? ((a = (URL || webkitURL).createObjectURL(a)),
                        /blob:(?!http[s]?).*/.test(a)
                          ? a.replace(
                              "blob:",
                              "blob:" + (c.protocol + "//" + c.host) + "/"
                            )
                          : a)
                      : A;
                  })(g);
              ...
              parseURL: function (a) {
                ...
                if ("string" !== typeof a)
                  return (
                    d.a.console.warn("URL was expected to be a string", a), A
                  );
                var b = a.match(
                  /^(http[s]?|file):\/\/([^/\n]*)([^?\n]*)(\?[^\n]*)?/
                );
          ...
          var d = {
            ...
            repeat: function (a, b) {
              ...
              c = function z() {
                q
                  ? B(k)
                  : (Date.now() - h >= p && ((h = Date.now()), a.apply(f, l)),
                    (k = e(z)));
              };
              c.stop = function () {
                q = !0;
          ...
          var d = c(4),
            ...
            g = function (a, b, c, d, g) {
              ...
              if (b && b[a])
                return l
                  ? b[a](c, d, g)
                  : b[a](c, d, "boolean" === typeof g ? g : g.capture || !1);
            };
          a = (function () {
            function a() {}
            ...
            b.a = function (b) {
              ...
              try {
                if (b.forEach)
                  ...
                  for (
                    var p = b[a.iterator](), h, q;
                    (h = p.next()), (q = h.value), !h.done;
        ...
        function (a, b, c) {
          ...
          var d = c(4),
            ...
            l = {
              ...
              orientation: function (a) {
                ...
                return null != a
                  ...
                  : ((a =
                      ...
                      a.screen.mozOrientation ||
                      a.screen.msOrientation) &&
                      a.angle) ||
                      0;
              },
              ...
              meta: function (a) {
                return (a = t.querySelector('meta[name\x3d"ym:' + a + '"]'))
                  ? a.content
                  : null;
              },
              scaleFactor: function (a, b) {
                ...
                return g > c || f > d
                  ? ((c /= g),
                    (d /= f),
                    Math.min(1, Math.max(c > d ? 0.1 : 0.35, Math.min(c, d))))
                  : 1;
              },
              viewportGetter: function (a) {
                ...
                var b = a.defaultView,
                  c = function (c) {
                    /Trident|MSIE/.test(b.navigator.userAgent)
                      ? a.body.parentNode && a.body.parentNode.appendChild(c)
                      : a.body.appendChild(c);
                  },
                  d = a.querySelector("ym-measure.ym-viewport"),
                  g = a.querySelector("ym-measure.ym-zoom");
                null === d &&
                  ((d = f.DOMUtils.createElement("ym-measure", {
                  ...
                  c(d));
                null === g &&
                  ((g = f.DOMUtils.createElement("ym-measure", {
                    className: "ym-zoom",
                    style: {
                      bottom: "100%",
                      position: "fixed",
                  ...
                  },
                  {
                    zoomLevel: {
                      get: function () {
                        try {
                          return parseFloat(
                            (g.clientWidth / b.innerWidth).toFixed(3)
                          );
                        } catch (F) {
                          return 1;
                        }
            ...
            a = (function () {
              ...
              a.mock = function () {
                if (!this.mocked) {
                  ...
                  HTMLCanvasElement.prototype.getContext = function (b) {
                    ...
                    if (null !== c)
                      return (
                        !1 !== this.proxy && 0 <= y.indexOf(b) && a.update(c), c
                      );
                  };
              ...
              a.remove = function () {
                this.mocked &&
                  ((this.mocked = !1),
                  this.events.off(),
                  (HTMLCanvasElement.prototype.getContext = h));
              };
              a.update = function (b) {
                if (!1 === a.proxies.has(b)) {
                  var c = this,
                    ...
                    g = k(b);
                  f.nodeIsRecordable(e) &&
                    g.properties &&
                    (f.forof(g.properties, function (a) {
                    ...
                    f.forof(g.methods, function (a) {
                      ...
                      Object.defineProperty(b, a, {
                        ...
                        value: function () {
                          for (
                            var d = arguments.length, k = Array(d), g = 0;
                            g < d;
                            g++
                          )
                            k[g] = arguments[g];
          ...
          (function (a) {
            ...
            d = (function () {
              ...
              c.executeNextJob = function (a) {
                void 0 === a && (a = !1);
                this.hasJobs &&
                  (a ? this._executeJobsSync() : this._executeJobsAsync());
              };
              c._executeJobsSync = function () {
                if (this.hasJobs && this.isRunning) {
                  for (
                    a.cancelAnimationFrame(this.executionFrameId);
                    this.hasJobs;
              ...
              c._executeJobsAsync = function () {
                ...
                if (this.hasJobs) {
                  ...
                  this.executionFrameId = a.requestAnimationFrame(function () {
                    for (
                      ;
                      b.hasJobs && (!b.jobExecutionStartStamp || 150 > c);
            ...
            f = {
              ...
              initDocument: function (a) {
                ...
                this.write(
                  ...
                  a ||
                    c +
                      "\x3chtml\x3e\x3chead\x3e\x3c/head\x3e\x3cbody\x3e\x3c/body\x3e\x3c/html\x3e"
                );
                this.close(b);
                return b;
              },
        ...
        function (a, b) {
          ...
          function l(a) {
            ...
            if ((q === d || !q) && clearTimeout)
              return (q = clearTimeout), clearTimeout(a);
            try {
              return q(a);
            } catch (Z) {
              try {
              ...
              return new a(function (a, b) {
                ...
                f.addEventListener("readystatechange", function () {
                  ...
                  4 === f.readyState &&
                    (200 <= k && 301 > k
                      ? "css" === c.type
                        ? ((k = ((f.getResponseHeader("Content-Type") || "")
                            .split("; ")
                            .map(function (a) {
                              return a.split("\x3d");
                            })
            ...
            b.a = function (a) {
              ...
              var b = a.getStamp || f,
                ...
                d = {
                  ...
                  log: function () {
                    for (
                      var a = arguments.length, b = Array(a), d = 0;
                      d < a;
                      d++
                    )
                      b[d] = arguments[d];
              ...
              Object.defineProperties(d, {
                _getTime: { value: (a.getTime || g).bind(d) },
            ...
            b.a = function () {
              ...
              return {
                ...
                create: function (a) {
                  ...
                  this.recorder = a;
                  this.checkInpudDescriptorOverrideAbility(a) &&
                    (a.indexer.dom.forEach(function (a) {
                      d.handleNodeIndex(a);
                    }),
                ...
                handleNodeIndex: function (a) {
                  if (
                    n.a.isValidNode(a.nativeNode) &&
                    "__ym_input_override_test" !==
                      a.nativeNode.getAttribute("class")
                  ) {
                    var b = a.nativeNode,
                      c = a.id,
                      d =
                        "radio" === a.attributes.type ||
                        "checkbox" === a.attributes.type;
                ...
                handleInputChangeValueEvent: function (a) {
                  ...
                  this.recorder.errorLogger(function () {
                    ...
                    if (d) {
                      var e = d.id;
                      if (!b.inputs[e] && (b.handleNodeIndex(d), !b.inputs[e]))
                        return;
                ...
                handleInputValueChange: function (a, b, c) {
                  ...
                  if (
                    (!b ||
                      -1 !==
                        ["string", "boolean", "number"].indexOf(typeof b)) &&
                    b !== d
                  ) {
                    if (e)
            ...
            b.a = function () {
              var b = {
                ...
                l = function (a) {
                  ...
                  a = this._getEventObject(c, e, { x: d, y: b }, a);
                  this._publishActions(a);
                },
                y = d.a.create(l, { timeout: 0 }),
                p = function (a) {
                  var b = this.stamp;
                  "mousemove" === a.type
                    ? y.call(this, a, b)
                    : l.call(this, { object: a, args: [b] });
                };
              return {
                create: function (a) {
        ...
        function (a, b, c) {
          (function (a, c) {
            b.a = function () {
              var b = { focus: { capture: !0 }, blur: { capture: !0 } },
                d = new a(),
                f = function (a) {
              ...
              return {
                ...
                create: function (a) {
                  b = a.attachEvent(
                    a.window,
                    "orientationchange",
                    a._universalHandler(c, { extra: [this] }),
                    { passive: !0 }
                  );
                },
                destroy: function (a) {
            ...
            b.a = function () {
              var b = {
                ...
                r = function (a) {
                  var b =
                    "select" === a.type
                      ? this.selection.getSelectionFor(a.target)
                      : this.selection.getPageSelection();
                  b &&
                  b.start !== b.end &&
                  -1 !== ["mousemove", "touchmove", "touchdown"].indexOf(a.type)
                    ? ((f = !0),
                      (a = this._getEventObject(
                        "selection",
                        "select" === a.type ? a.target : this.rootNode,
                        b
                      )),
                      this._publishActions(a))
                    : f &&
          ...
          (function (a, f, l) {
            ...
            b.a = function () {
              var b = {
                ...
                q = d.a.create(F, { timeout: l.isAndroid() ? 0 : 300 }),
                k = function (a) {
                  var b = this.stamp,
                    c = "touchcancel" === a.type || "touchend" === a.type;
                  a.changedTouches &&
                    0 < a.changedTouches.length &&
                    l.forof(a.changedTouches, function (a) {
                      var b = void 0 === c ? !1 : c;
              ...
              return {
                create: function (a) {
                  ...
                  c.add(
                    a.attachEvent(a.document, "scroll", f, {
                      passive: !0,
                      capture: !0,
                    })
                  );
                ...
                h = function (a) {
                  a = d
                    ? this._getEventObject(
                        r[t[d.hidden] ? "blur" : "focus"],
                        this.window
                      )
                    : this._getEventObject(r[a.type], this.window);
                  this._publishActions(a);
                };
              return {
                create: function (a) {
          ...
          (function (a) {
            ...
            d = (function (b) {
              ...
              e.addChanges = function (b, c) {
                for (
                  var e = arguments.length, d = Array(2 < e ? e - 2 : 0), k = 2;
                  k < e;
                  k++
                )
                  d[k - 2] = arguments[k];
              ...
              e.collectMutations = function (a) {
                ...
                this.queue.push(function () {
                  ...
                  c.hasData &&
                    b.emit("mutation", { changes: c.store, stamp: a.stamp });
                });
              };
              e.destroy = function () {
                this.queue.start(!0);
              ...
              e.processMutations = function (b) {
                ...
                a.fastIterate(b, function (a, b) {
                  if (
                    b.target.parentNode &&
                    !m.c.isIgnoredNode(b.target.parentNode)
                  ) {
                ...
                a.fastIterate(void 0 === b ? [] : b, function (b, e) {
                  k.indexer.reindexNodeTree(e, {
                    ...
                    callback: function (b, c) {
                      if (b) {
                        var d = a.combine(
                          { id: b.id, pa: b.parent, nm: b.name },
                          c === e
                            ? { pr: k.getIDForNode(f), nx: k.getIDForNode(g) }
                            : {}
                        );
              ...
              e.processAttributesChanges = function (a, b, c, e) {
                ...
                this.addChanges(e, "c", {
                  id: b,
                  at: ((d = {}), (d[a] = { n: k, o: c, r: g }), d),
                });
              };
              e.processContentChanges = function (a, b, c, e) {
                this.addChanges(e, "d", {
                  id: b,
                  ct: { n: a.meta.newValue, o: a.meta.oldValue },
                });
              };
          ...
          (function (a, f, l) {
            ...
            d = (function (b) {
              ...
              d.initMutationObserver = function () {
                ...
                c
                  ? (this.observer = new c(function () {
                      try {
                        for (
                          var a = arguments.length, c = Array(a), e = 0;
                          e < a;
                          e++
                        )
                          c[e] = arguments[e];
                ...
                switch (a) {
                  case "childList":
                    ...
                    if (0 < b.length || 0 < d.length)
                      return { addedNodes: b, removedNodes: d };
                    break;
                  case "attributes":
                    a = d.attributeName;
                    d = d.oldValue;
                    ...
                    break;
                  case "characterData":
                    if (((d = d.oldValue), (b = b.textContent), b !== d))
                      return { oldValue: d, newValue: b };
                }
              };
              return c;
            })(c(15).a);
        ...
        function (a, b, c) {
          a = (function () {
            ...
            b.getKeySymbol = function (a) {
              return (
                this.keyDict[this.OS][a.keyCode] ||
                this.keyDict.multi[a.keyCode] ||
            ...
            b.cancelCapture = function () {
              this.isModifierPressed()
                ? I(this.cancelCapture.bind(this), 100)
            ...
            b.keydownHandler = function (a) {
              this.applyFilters(a.target) &&
                !1 === this.isInputWithShift(a) &&
                !a.repeat &&
                0 > this.held(a.keyCode) &&
                (this.holding.push(a.keyCode),
                this.isModifier(a.keyCode) && !this.isModifierPressed()
                  ? ((this.modifierPressed += 1),
                    this.startCapture(a),
                    this.reset())
                  : this.isModifierPressed()
                  ? (this.cancelReset(), this.pushKey(a), this.endCapture())
                  : (this.resetImmediate(), this.pushKey(a)));
            };
            b.keyupHandler = function (a) {
              if (this.applyFilters(a.target)) {
                ...
                1 === this.keyStroke.length &&
                  ((b = this.keyStroke[0]),
                  0 <= this.singleKeys.indexOf(b.keyCode) &&
                    (this.sendKeys([b], !0), this.resetImmediate()));
                this.removeKey(a);
                clearTimeout(this._endCapture);
              }
            };
            b.attachEvent = function (a, b) {
              var c = this;
              if ("function" === typeof b) {
                var d = this.ctx.attachEvent(
                  this.ctx.document,
                  a,
                  function (a) {
                    ((c.root && c.root.contains(a.target)) ||
                      a.target === c.root) &&
                      c.ctx.errorLogger(function () {
                        b.call(c, a);
                      });
                  },
                  !0
            ...
            b.isInitialModifier = function (a) {
              return this.initialModifier
                ? this.initialModifier.keyCode === a.keyCode
                : !1;
            };
            b.isCaptured = function (a) {
              return (
                null !=
                this.keyStroke.reduce(function (b, c) {
            ...
            b.isInputWithShift = function (a) {
              return "INPUT" === a.target.nodeName
                ? a.shiftKey ||
                    32 === a.keyCode ||
                    "shift" === this.modifierCodes[a.keyCode]
                : !1;
            };
            b.destroy = function () {
              var a;
            ...
            var F = {},
              ...
              k = (function () {
                ...
                c.mock = function () {
                  ...
                  p.IterableUtils.forof(F.methods, function (e) {
                    ...
                    Object.defineProperty(b, e, {
                      ...
                      value: function () {
                        for (
                          var a, b = arguments.length, k = Array(b), f = 0;
                          f < b;
                          f++
                        )
                          k[f] = arguments[f];
                ...
                c.remove = function () {
                  ...
                  p.IterableUtils.forof(this.originalDescriptors, function (
                    b,
                    c
                  ) {
                    delete a[c];
          ...
          (function (a, f) {
            ...
            d = (function (b) {
              ...
              d.addQuckAccessItem = function (a, b) {
                null == this.quickAccess[a] &&
                  null == this[a] &&
                  ((this.quickAccess[a] = b),
              ...
              d.addToIndex = function (a, b, c) {
                ...
                if ((a = this.middleware.run(a))) {
                  ...
                  if (!1 === this.dom.has(a) || null == e) {
                    ...
                    this.recorder &&
                      "INPUT" === d &&
                      ((b = Z.a.validate(a, this.recorder.options)),
                      (d = b.forceRecord),
                      (b = !b.isAllowed && !d),
                      (d = e.attributes.value),
                      (e.attributes.value = b ? Z.a.encode(d) : d),
                      b && (e.hidden = !0));
              ...
              d.clear = function (a) {
                void 0 === a && (a = !0);
                k.IterableUtils.forof(k.IterableUtils.keys(this.dom), function (
                  a
                ) {
                  k.IterableUtils.forof(
              ...
              d.find = function (a) {
                if (null != a) {
                  ...
                  return null == b && this.domCache
                    ? (a = this.findCache(a)) && a.node
                    : b;
                }
              };
              ...
              d.getIndexedNodeId = function (a) {
                ...
                return null == b
                  ? (this.reindexNodeTree(a), this.getNodeId(a))
                  : b;
              };
              ...
              d.reindexNodeTree = function (a, b) {
                ...
                if (a) {
                  var l = [];
                  if (a.parentNode || g)
                    (f = B.FunctionUtils.toFunction(f)),
              ...
              d.removeFromIndex = function (a) {
                ...
                this.dom["delete"](a);
                this.index["delete"](b);
                k.IterableUtils.toArray(a.childNodes).map(
            ...
            p()(d, "toNodesTree", function (a) {
              ...
              k.IterableUtils.forof(a, function (a) {
                if (null == b[a.id]) {
                  ...
                  null != a.parent &&
                    (a = b[a.parent]) &&
                    ((a.children = a.children || []), a.children.push(c));
                }
              });
              return b[0];
            });
            ...
            d = (function () {
              ...
              c.send = function (a, b) {
                ...
                (function za() {
                  ...
                  if (q && y) {
                    ...
                    b = Date.now() - t >= b;
                    !1 === p &&
                      (b ? "function" === typeof g && g() : (m = I(za, 100)));
                  }
                })();
              };
              c.subscribe = function (a, b) {
                ...
                if (!1 === this._isSubscribed(c, b)) c.push(b);
                  ...
                  throw Error(
                    "This callback has already been subscribed to " + a
                  );
              };
                      ...
                      if (
                        ...
                        if (null === f)
                          ...
                          for (d = c.length; b < d; b++) {
                            ...
                            e
                              ? (function () {
                                  var b = { type: e, target: f.contentWindow },
                                    c = 2 === n.length,
                                    d = null,
                                    k = function (e) {
                                      clearTimeout(d);
              ...
              c._findIframe = function (b, c) {
                ...
                return (
                  a.find(d, function (a) {
                    ...
                    if (h.DOMUtils.isBlankOrSameOriginIframe(a, e.win))
                      try {
            ...
            d = (function () {
              ...
              c.getSelection = function () {
                if (0 < this.selection.rangeCount) {
                  var a =
                    this.selection.getRangeAt(0) || this.document.createRange();
                  return {
                    start: a.startOffset,
                    end: a.endOffset,
              ...
              c.restoreSelectionFor = function (a, b) {
                b &&
                  null != b.start &&
                  null != b.end &&
                  /text|search|password|tel|url/.test(a.type) &&
                  ((a.selectionStart = b.start), (a.selectionEnd = b.end));
              };
              c.clear = function () {
          ...
          (function (a) {
            var d = c(4),
              ...
              g = {
                ...
                localStorage: function () {
                  try {
                    return (
                      d.a.localStorage.setItem("test", "value"),
            ...
            b.a = (function () {
              a.forin(g, function (a) {
                if (!g[a]())
                  return l["default"].log("Feature not supported: " + a), !1;
              });
              return !0;
            })();
          }.call(this, c(7)["default"]));
            ...
            var g = c(0),
              ...
              h = {
                ...
                resetMultiple: function () {
                  for (
                    var a, b = this, c = arguments.length, e = Array(c), d = 0;
                    d < c;
                    d++
                  )
                    e[d] = arguments[d];
            ...
            d = Object.defineProperties(
              {
                ...
                applyPatch: function (b, c) {
                  ...
                  d = b;
                  h.resetAll();
                  if (h.test("dataurlTest", b) || h.test("selectorTest", b))
                    return b;
                  h.test("protocolMissing", b) &&
                    (d = h.test("protocolIncomplete", b)
                      ? b.replace(h.get("protocolIncomplete"), g + "//")
                      : g + "//" + (k + "/" + e).replace(/\/\/+/, "/"));
                  q.set(b, d);
                  /http[s]?/.test(d)
                    ? ((k = d),
                      h.test("proxiedURL", k)
                        ...
                        : (p.isWhitelisted
                            ? (g = p.isWhitelisted(k)) &&
                              a.warn("Whitelisted: " + k)
                            : (g = !1),
                          (d = g
                            ? k
                            : (g = p.proxy) && h.test("resourceFinder", g)
                            ? g.replace(
                  ...
                  return a
                    ? b
                      ? ((b = n.StringUtils.parseURL(e(a))),
                        ...
                        b ||
                          r.ObjectUtils.assign({}, this.location, { path: a }))
                      : r.ObjectUtils.assign({}, this.location, { path: a })
                    : this.location;
                },
                resolvePath: function (a, b) {
                  ...
                  for (
                    ...
                    "" === g
                      ? (e.length = 0)
                      : "." !== g &&
                        (".." === g ? 0 < e.length && --e.length : e.push(g));
                  }
                  e.unshift("");
                  return e.join("/");
                },
                ...
                isURLLike: function (a) {
                  ...
                  return h.test("dataurlTest", a) || h.test("selectorTest", a)
                    ? !1
                    : h.test("extnameFinder", a) &&
                        h.test("protocolMissing", a);
                },
                clearCache: function () {
                  F.clear();
                  q.clear();
              ...
              },
              {
                location: {
                  ...
                  set: function (a) {
                    return (p = r.ObjectUtils.assign({}, p, { location: a }))
                      .location;
                  },
                  configurable: !0,
                  enumerable: !0,
              ...
              return {
                create: function (a) {
                  a.keyCapture.onCapture(function (b) {
                    ("OBJECT" === t.activeElement.nodeName &&
                      /flash/.test(t.getAttribute("type"))) ||
                      ((b = a._getEventObject("keystroke", -1, b)),
                      a._publishActions(b));
                  });
                },
                destroy: function (a) {
              ...
              return {
                ...
                create: function (c) {
                  a = c.attachEvent(
                    c.window,
                    "resize",
                    c._universalHandler(b, { extra: [this] }),
                    { passive: !0 }
                  );
                },
                destroy: function (b) {
            ...
            srcset: function () {
              return {
                ...
                onImageLoad: function (a) {
                  ...
                  this.recorder.errorLogger(function () {
                    var c = a.target;
                    "IMG" === (c.tagName || c.nodeName) &&
                      c.getAttribute("srcset") &&
                      b.recorder.summary.collectMutations({
                        summary: [
                          {
                            meta: {
                              name: "src",
        ...
        function (a, b, c) {
          ...
          var d = c(12),
                ...
                return (a || "")
                  ...
                  .map(function (a) {
                    return b.isNumber(a)
                      ...
                      : b.isLetter(a)
                      ? b.isUpperCase(a)
                        ? b.charFromRange(65, 90)
                        : b.charFromRange(97, 122)
                      : a;
                  })
                  .join("");
              },
            ...
            h = function (a, b) {
              ...
              a.attributes &&
                (f.DOMUtils.copyAttributes(a, c), (c.className = a.className));
                  ...
                  switch (c) {
                    ...
                    case "IMG":
                      return (
                        ...
                        (b = b.bounds),
                        (a.src =
                          "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII\x3d"),
                        (a.width = b.width),
                        (a.height = b.height),
                        a
                      );
          ...
          (function (a, f, l) {
            ...
            var M = c(26),
              ...
              O =
                ia.IS_INCOGNITO ||
                ia.DO_NOT_TRACK ||
                "disable" === ca.BrowserUtils.meta("webvisor"),
              Fa = m !== m.top;
            m.__YM_WV_RECORDABLE__ === A &&
              Object.defineProperty(m, "__YM_WV_RECORDABLE__", { value: !0 });
            var qa = (function (b) {
                function c(c, d) {
                  void 0 === c && (c = {});
                  void 0 === d && (d = {});
                  var k = b.call(this) || this;
                  e()(q()(k), "middlewares", []);
                  e()(q()(k), "options", ha.ObjectUtils.assign({}, U));
                  ...
                  e()(q()(k), "_slaveMessengerRegistrationHandler", function (
                    a,
                    b
                  ) {
                    return function (c, e) {
                  ...
                  k._context = (function (a) {
                    ...
                    return a
                      ? ((b.window = a.window || m),
                        (b.document = a.document || t),
                        b)
                      : { window: m, document: t };
                  })(d);
                  k.sender = new x.a(k.middlewares.splice(0));
                  k.captors = new a();
                  k._timer = Q.TimeUtils.timer();
                ...
                d.configure = function () {
                  var a = ha.ObjectUtils.combine(
                    {},
                    p()({}, U, this._configOptions)
                  );
                  this.frames = [];
                  ...
                  P.c.addAttributesFilter(function (b, c, e) {
                    if (G.a.isValidNode(b) && "value" === c)
                      return (
                        (b = G.a.validate(b, a)),
                        (c = b.forceRecord),
                        b.isAllowed || c ? e : G.a.encode(e)
                      );
                    if (
                      "checked" === c &&
                      ["INPUT", "CHECKBOX", "RADIO"].includes(b.nodeName)
                    )
                ...
                d.attachEvent = function () {
                  for (
                    var a, b = arguments.length, c = Array(b), e = 0;
                    e < b;
                    e++
                  )
                    c[e] = arguments[e];
                ...
                d.init = function (a) {
                  var b = this;
                  void 0 === a && (a = {});
                  this.initOptions = ha.ObjectUtils.assign(
                    {},
                    this.initOptions,
                    a || {}
                  );
                          ...
                          function (a) {
                            for (;;)
                              switch ((a.prev = a.next)) {
                                ...
                                case 11:
                                  return (
                                    (a.next = 13), b.__handleDocumentLoad()
                                  );
                                case 13:
                                case "end":
                                  return a.stop();
                ...
                d.__handleDocumentLoadError = function (a) {
                  var b = a;
                  "timeout" === a.message &&
                    (b = Error("No \x3cbody\x3e found. Can't continue"));
                  this.fatal("init-failed", b);
                };
                d.__handleDocumentLoad = (function () {
                  var a = y()(
                    h.a.mark(function Aa() {
                      var a = this;
                      return h.a.wrap(
                        function (b) {
                          for (;;)
                            switch ((b.prev = b.next)) {
                              ...
                              case 5:
                                (this.waitingDocument = !1),
                                  (this.ableToStart = !0),
                                  (this.cancelIfNotStarted = I(function () {
                                    a.stop(!0, !1);
                                  }, 3e4)),
                                  this.emit("ready"),
                                  (this.inited = !0),
                ...
                d.connectSlaveRecorder = function (a) {
                  ...
                  if (
                    "IFRAME" === a.nodeName &&
                    a.name !== Z.a.NATIVE_IFRAME_NAME &&
                    V.DOMUtils.isBlankOrSameOriginIframe(a, this.window)
                  ) {
                    try {
                      var c =
                        0 <
                          a.contentDocument.documentElement.childNodes.length &&
                      ...
                      d = function (c) {
                        b.errorLogger(function () {
                          if (
                            ...
                            c.parentElement &&
                            c.contentDocument &&
                            V.DOMUtils.isBlankOrSameOriginIframe(a, b.window) &&
                            !0 !== c.contentWindow.__WV_ENABLED__
                          )
                            try {
                              e(c);
                            } catch (fb) {
                ...
                d.start = function (a) {
                  ...
                  this.errorLogger(function () {
                    if (b.ableToStart)
                      if (!1 === b.fatalError)
                        if (!b.inited)
                          ...
                          if (S && !O) {
                            clearTimeout(b.cancelIfNotStarted);
                            var c = (a || {}).forms;
                            b.options.recording = ha.ObjectUtils.combine(
                              {},
                              U.recording,
                              {
                                keysMode:
                                  void 0 === c || c ? "regular" : "explicit",
                              }
                            );
                      ...
                      (function X() {
                        b.ableToStart ? b.start(a) : I(X, 50);
                      })();
                  }, "start");
                };
                d.stop = function (a, b) {
                ...
                d._initCaptors = function () {
                  ...
                  this.keyCapture.addElementFilter(function (a) {
                    return "INPUT" === a.nodeName
                      ? "password" !== a.type &&
                          !1 === /ym-disable-keys/.test(a.className)
                      : !0;
                  });
                  var b = ha.ObjectUtils.combine(
                    {},
                    Z.a.captors,
                    Fa ? Z.a.iframeCaptors : null
                  );
                ...
                d._blockUpcomingCaptor = function (a, b) {
                  ...
                  void 0 === b && (b = Infinity);
                  a &&
                    ((this._blockedCaptors = this._blockedCaptors || new l()),
                ...
                d._releaseCaptor = function (a) {
                  a &&
                    this._blockedCaptors.has(a) &&
                    this._blockedCaptors["delete"](a);
                };
                d._executeCaptor = function (a, b) {
                  a &&
                    "function" === typeof b &&
                    (this._blockedCaptors && this._blockedCaptors.has(a)
                      ? this._releaseCaptor(a)
                      : b());
                };
                ...
                d._getScrollForEachNode = function (a) {
                  ...
                  return z.IterableUtils.toArray(a).reduce(function (a, c) {
                    ...
                    0 < c.childNodes.length &&
                      (a = a.concat(b._getScrollForEachNode(c.childNodes)));
                    return a;
                  }, []);
                };
                d._getScroll = function (a) {
                  var b = a.scrollTop,
                    c = a.scrollLeft;
                  if (0 < b || 0 < c)
                    return { target: this.findNode(a), scroll: [b, c] };
                };
                          ...
                          return h.a.wrap(function (e) {
                            for (;;)
                              switch ((e.prev = e.next)) {
                                ...
                                case 5:
                                  (c = e.sent) &&
                                    a.fatal("messenger-init-failed", c);
                                case 7:
                                  b();
                                case 8:
                                case "end":
                ...
                d._initMasterMessenger = function () {
                  ...
                  this.messenger.subscribe("iframe_data", function (b) {
                    ...
                    if (null != e) {
                      ...
                      if (c.events) {
                        b = V.DOMUtils.offsets(b, { excludeBorder: !0 });
                        var k = b.left,
                          g = b.top;
                        b = c.events.map(function (b) {
                          /mouse/.test(b.type) &&
                            ((b.meta.x = Math.round(b.meta.x + k)),
                ...
                d._request = function (a, b, c) {
                  ...
                  (this._EOF_SENT && !0 !== c) ||
                    (!0 === this.started || !0 === c
                      ? ((b = ha.ObjectUtils.combine(
                          { _v: Z.a["package"].version },
                          p()({}, b)
                        )),
                        this.sender.send({ url: a, data: p()({}, b) }))
                ...
                d._createSnapshot = function () {
                  var a = this,
                    b = f
                      ...
                      .then(function (a) {
                        return { content: a.content, error: a.error };
                      });
                  this.snapshot = {
                    get: function (c) {
                      var e = c.onSuccess,
                ...
                d._universalHandler = function (a, b) {
                  ...
                  return function () {
                    for (
                      var b = arguments.length, e = Array(b), k = 0;
                      k < b;
                      k++
                    )
                      e[k] = arguments[k];
                    ...
                    get: function () {
                      ...
                      return {
                        meta: {
                          ...
                          screen: { width: ea.width, height: ea.height },
                          location: {
                            host: L.host,
                            protocol: L.protocol,
                            path: L.pathname,
        ...
        function (a, b, c) {
          (function (b) {
            ...
            a.exports = function () {
              ...
              return c[typeof b.iterator] &&
                c[typeof b.toPrimitive] &&
                c[typeof b.toStringTag]
                ? !0
                : !1;
            };
          }.call(this, c(25)["default"]));
        ...
        function (a, b, c) {
          (function (b) {
            ...
            a.exports = p = function Z(a) {
              if (this instanceof Z)
                throw new TypeError("Symbol is not a constructor");
              if (k) return q(a);
              var b = g(B.prototype);
              a = a === A ? "" : String(a);
              return h(b, { __description__: d("", a), __name__: d("", e(a)) });
            };
            h(p, {
              for: d(function (a) {
              ...
              isConcatSpreadable: d(
                "",
                (q && q.isConcatSpreadable) || p("isConcatSpreadable")
              ),
        ...
        function (a, b, c) {
          ...
          (a.exports = function (a, b) {
            ...
            if (null == a) {
              ...
              (h = g.call(a, "c")), (q = g.call(a, "e")), (c = g.call(a, "w"));
            h = { value: b, configurable: h, enumerable: q, writable: c };
            return l ? d(f(l), h) : h;
          }).gs = function (a, b, c, h) {
        ...
        function (a, b, c) {
          a.exports = function (a) {
            return a
              ? "symbol" === typeof a
                ? !0
                : a.constructor && "Symbol" === a.constructor.name
                ? "Symbol" === a[a.constructor.toStringTag]
                : !1
              : !1;
          };
        },
          ...
          (function (b) {
            (function (b, c) {
              ...
              function u(b, c, e) {
                ...
                e === q &&
                c.constructor.resolve === k
                  ? Z(b, c)
                  : e === S
                  ? (G(b, S.error), (S.error = null))
                  : e === A
                  ? x(b, c)
                  : a(e)
                  ? z(b, c, e)
        ...
        function (a, b, c) {
          (function (b, c) {
            !(function (d) {
              function g(a, b, c, e) {
                b = Object.create(
                  (b && b.prototype instanceof l ? b : l).prototype
                );
                e = new z(e || []);
                b._invoke = k(a, c, e);
                return b;
              ...
              function k(a, b, c) {
                ...
                return function (k, g) {
                  ...
                  for (c.arg = g; ; ) {
                    ...
                    "throw" === l.type &&
                      ((d = L), (c.method = "throw"), (c.arg = l.arg));
                  }
                };
              }
              function e(a, b) {
                ...
                if (c.done)
                  (b[a.resultName] = c.value),
                    (b.next = a.nextLoc),
                    "return" !== b.method && ((b.method = "next"), (b.arg = w));
                else return c;
                b.delegate = null;
                return J;
              }
              ...
              if (D) x && (a.exports = D);
                ...
                D.async = function (a, b, c, e) {
                  ...
                  return D.isGeneratorFunction(b)
                    ? d
                ...
                z.prototype = {
                  ...
                  dispatchException: function (a) {
                    ...
                    for (
                      var c = this, e = this.tryEntries.length - 1;
                      0 <= e;
                      --e
                    ) {
                  ...
                  abrupt: function (a, b) {
                    ...
                    c.arg = b;
                    return d
                      ? ((this.method = "next"), (this.next = d.finallyLoc), J)
                      : this.complete(c);
                  },
                  ...
                  finish: function (a) {
                    for (var b = this.tryEntries.length - 1; 0 <= b; --b) {
                      ...
                      if (c.finallyLoc === a)
                        return this.complete(c.completion, c.afterLoc), H(c), J;
                    }
                  },
                  catch: function (a) {
                    for (var b = this.tryEntries.length - 1; 0 <= b; --b) {
  ...
  var w = J.inherit({
    ...
    on: function (a, b, c, d, f) {
      ...
      for (h = 0; h < l; h++) {
        ...
        a.addEventListener
          ? a.addEventListener(r, y, w._prepOpts(f))
          : a.attachEvent && a.attachEvent("on" + r, y);
      }
    },
    ...
    _removeListener: function (a, b, c, d) {
      a.removeEventListener
        ? a.removeEventListener(b, c, w._prepOpts(d))
  ...
  var x = {
    ...
    getMs: function () {
      return 0 < this.UNLOAD_MS
        ? this.UNLOAD_MS
        : this.isPerfomance
        ? Math.round(m.performance.timing.navigationStart + m.performance.now())
        : x.oldMs();
    },
    getFormStart: function () {
      return this.isPerfomance
        ? Math.round(m.performance.now())
  ...
  x.isPerfomance ||
    ...
    (x.lastNowTime = 0),
    (x.correctTime = 0),
    (x.timeCorrector = function (a) {
      x.correctTime = x.getMs();
      a &&
        x.correctTime < x.lastTime &&
        (x.deltaTime += a - x.correctTime + 20);
      h.setTimeout(
        function () {
  ...
  h.isArray = function (a) {
    return h.isFunction(Array.isArray)
      ? Array.isArray(a)
      : "[object Array]" === h.toString(a);
  };
  ...
  var Wa = J.inherit({
      ...
      _initComponent: function () {
        ...
        this._flushTID = null;
        this._saveToStorageThrottled = h.throttle(
          this._saveToStorage,
          300,
          this,
        ...
        this.storage &&
          ...
          a.meta &&
          a.time &&
          a.time + this.bufferExpireTime > +x.getMs() &&
          this.onFlush.call(
    ...
    if (m.postMessage) {
      ...
      var f = function (c) {
        ...
        g === d &&
          ...
          a.call(b),
          w.un(m, "message", f, null, { passive: !1 }));
      };
      w.on(m, "message", f, null, { passive: !1, name: ".async." + (c || "") });
      m.postMessage(d, "*");
    } else
          ...
          for (n = 0; n < d.length; n++)
            c.push({
              ...
              value:
                ...
                "\x3d" +
                encodeURIComponent(String(d[n])),
            });
        else
          c.push({
            key: g,
            value:
              encodeURIComponent(g) + "\x3d" + encodeURIComponent(String(d)),
          });
    c.sort(function (a, b) {
      var c = f[a.key],
        d = f[b.key];
  ...
  var Ba = J.inherit({
      ...
      _buildUrl: function (a, b) {
        var c = wa.stringify(b, this.queryStringParams);
    ...
    Xa = Ba.inherit({
      ...
      request: function (a, b, c, d) {
        ...
        if (
          /[^a-z0-9.:-]/.test(L.host) &&
          m.opera &&
          "function" === typeof m.opera.version
        ) {
    ...
    request: function (a, b, c, d) {
      ...
      navigator.onLine
        ? ((b = this._splitParams(b)),
          ...
          c.call(
            d,
            navigator.sendBeacon(this._buildUrl(a, b.get), wa.stringify(b.post))
          ))
        : c.call(d, !1);
    },
  });
  ...
  var Za = Ba.inherit({
      ...
      _initComponent: function () {
        ...
        "_htmlfile" in Za.prototype ||
          (Za.prototype._htmlfile = this._createHtmlfile());
    ...
    bc = Za.inherit({ id: "htmlfile", index: 3, htmlfileOnly: !0 }),
    Ca = Ba.inherit({
      id: "img",
      index: 4,
      request: function (a, b, c, d) {
    ...
    switch (a.constructor) {
      ...
      case Object:
        ...
        for (d in a)
          a.hasOwnProperty(d) &&
            a[d] !== A &&
            (c[c.length] = h.toJSON(d) + ":" + h.toJSON(a[d]));
        return "{" + c.join(",") + "}";
      default:
  ...
  var S = J.inherit({
    ...
    set: function (a, b) {
      if (this.isEnabled())
        try {
          !b || (b && h.isArray(b) && !b.length)
            ? this.remove(a)
            : this._ls.setItem(this._getLsKey(a), h.toJSON(b));
        } catch (c) {}
    },
    get: function (a) {
      if (this.isEnabled())
  ...
  h.hiddenFrameCreate = function (a, b) {
    var c;
    if ((c = h._hiddenFrames[a]))
      return (
        -1 === h.arrayIndexOf(c.owners, b) && c.owners.push(b),
        h.framePostMessage(c.frame, "frameReinit", "*"),
        c.frame
      );
    ...
    h._hiddenFrames[a] = { frame: c, owners: [b] };
    return c;
  };
  h.hiddenFrameRemove = function (a, b) {
    var c = h._hiddenFrames[a],
      d;
    c &&
      -1 !== h.arrayIndexOf(c.owners, b) &&
      ((c.owners = h.filter(function (a) {
        return a !== b;
      }, c.owners)),
      c.owners.length ||
        ((d = c.frame.parentNode) && d.removeChild(c.frame),
        delete h._hiddenFrames[a]));
  };
  var ja = {
      ...
      decode: function (a, b) {
        for (
          var c = ja.abc + (b ? ja.tailSafe : ja.tail),
            d = 0,
            f = "",
            l,
            g,
        ...
        do {
          ...
          f =
            64 == r
              ...
              : 64 == y
              ? f + String.fromCharCode(l, g)
              : f + String.fromCharCode(l, g, h);
        } while (d < a.length);
        return f;
      },
    },
  ...
  var N = J.inherit({
    ...
    create: function (a, b, c) {
      b = [this._prepareName(a) + "\x3d" + encodeURIComponent(b)];
      if (this.isAllowed(a)) {
        c &&
          ((a = new Date()),
          a.setTime(a.getTime() + 6e4 * c),
          b.push("expires\x3d" + a.toGMTString()));
        this.sameSiteStr &&
          "https:" === m.location.protocol &&
          (b.push(this.sameSiteStr), b.push("Secure"));
    ...
    isAllowed: function (a) {
      return h.inArray(["metrika_enabled", "gdpr", "gdpr_popup"], a)
        ? !0
        : la.isAnalyticsCookeAllowed
        ? la.isAnalyticsCookeAllowed(E)
        : !1;
    },
  ...
  N.get = function (a) {
    return new N({ onlyCurrentDomain: !0 }).read(a);
  };
  N.set = function (a, b, c) {
    return new N({ onlyCurrentDomain: !0 }).create(a, b, c);
  };
  N.isEnabled = function () {
    return new N({ onlyCurrentDomain: !0 }).isEnabled();
  };
  ...
  u.isFF = D(function (a) {
    ...
    m &&
      ...
      (b =
        "MozAppearance" in m.document.documentElement.style &&
        "undefined" !== typeof m.InstallTrigger);
    if (
      b &&
      a &&
      m.navigator &&
  ...
  u.isITPSafari = h.memorize(function () {
    ...
    return (
      (u.isIOS() || 10 < a[0] || (10 === a[0] && 13 <= a[1])) && u.isSafari()
    );
  });
  var Da = {
      _storage: new S(),
      ...
      checkVersion: function () {
        ...
        return this.globalConfig.get("isEU")
          ...
          : (50 <= b && 99 >= b) || (a && 79 <= a)
          ? 0
          : !u.isITPSafari() || u.isSafariWebView();
      },
      noop: function () {},
      genPu: function (a) {
      ...
      onicecandidate: D(function (a) {
        ...
        c &&
          0 < c.length &&
          ((this.pp = h.fnv32a(c[1])), this.globalConfig.set("pp", this.pp));
        a.onicecandidate = this.noop;
        a.close();
      }, "wrt"),
      onOffer: function (a, b) {
        h.isFunction(a.setLocalDescription) &&
      ...
      initZZ: function () {
        ...
        if (!this.getZZ() && (!this.checkVersion() || b)) {
          if (b || (c && 79 <= c)) a = "md";
          this.zzUrl =
            "https://mc.yandex." + a + ja.decode("L21ldHJpa2EvenpsYy5odG1s");
          h.hiddenFrameCreate(this.zzUrl, this.key);
          w.on(m, "message", this.onMessage, this, { passive: !1 });
          this.timeout = h.setTimeout(
            function () {
              w.un(m, "message", d.onMessage, d, { passive: !1 });
      ...
      onMessage: function (a) {
        a.data &&
          ...
          h.hiddenFrameRemove(this.zzUrl, this.key),
          this._storage.set(this.key, this.zz),
          w.un(m, "message", this.onMessage, this, { passive: !1 }),
      ...
      _sendSavedRequest: function (a, b, c, d, f) {
        ...
        if ("process" == l)
          this.globalConfig.set(
            "firstReqCallbacks",
            h.mergeArrays(this.globalConfig.get("firstReqCallbacks") || [], [
              [this, arguments],
            ])
          );
        else {
  ...
  W.initCookie = function (a) {
    var b = new N({ onlyCurrentDomain: "uid" !== a }),
      c = b.read(a),
      d = W._storage.get(a),
      f = !1,
      l = b.read("d"),
    ...
    d &&
      !c &&
      ((c = d), (f = !0), b.create(a, c, 525600), b.create("d", g, 525600));
    if (!c)
      (c = g + "" + h.random()),
        b.create(a, c, 525600),
        b.create("d", g, 525600);
    else if (!l || 15768e3 < g - parseInt(l))
      b.create(a, c, 525600), b.create("d", g, 525600);
    W._storage.set(a, c);
    W._userID = c;
    return f;
  };
  ...
  h.warning = function () {
    m.console &&
      "function" === typeof m.console.warn &&
  ...
  h.isMetrikaPlayer = function () {
    return (
      "MetrikaPlayer" == m.name || this._playerRegexp.test(m.location.hostname)
    );
  };
  ...
  var v = {},
    fc = h.memorize(function () {
      var a = {},
        ...
        d,
        f = "A B BIG BODY BUTTON DD DIV DL DT EM FIELDSET FORM H1 H2 H3 H4 H5 H6 HR I IMG INPUT LI OL P PRE SELECT SMALL SPAN STRONG SUB SUP TABLE TBODY TD TEXTAREA TFOOT TH THEAD TR U UL ABBR AREA BLOCKQUOTE CAPTION CENTER CITE CODE CANVAS DFN EMBED FONT INS KBD LEGEND LABEL MAP OBJECT Q S SAMP STRIKE TT ARTICLE AUDIO ASIDE FOOTER HEADER MENU METER NAV PROGRESS SECTION TIME VIDEO NOINDEX NOBR MAIN svg circle clippath ellipse defs foreignobject g glyph glyphref image line lineargradient marker mask path pattern polygon polyline radialgradient rect set text textpath title".split(
          " "
        );
  ...
  v.getDocumentTitle = function () {
    ...
    "string" != typeof a &&
      (a =
        (a = t.getElementsByTagName("title")) && a.length
          ? a[0].innerHTML
          : "");
    return a;
  };
  u.getSilverlightVersion = h.memorize(function () {
    if (m.ActiveXObject)
      ...
      ((b = m.navigator), (b = b.plugins && b.plugins["Silverlight Plug-In"]))
    )
      f = b.description;
    return f || "";
  });
  ...
  u.isHeadLess = h.memorize(function () {
    ...
    return /PhantomJS/.test(m.navigator.userAgent) ||
      m.navigator.webdriver ||
      (m.isChrome && !m.chrome)
      ? !0
      : /HeadlessChrome/.test(m.navigator.userAgent);
  });
  ...
  u.isSelenium = h.memorize(function () {
    ...
    if (
      m.external &&
      m.external.toString &&
      0 <= m.external.toString().indexOf("Sequentum")
    )
      return !0;
  ...
  var gc = h.memorize(function () {
    ...
    Ra = W.inherit({
      ...
      paramsQueue: {
        ...
        _reduce: function (a) {
          return function (b, c) {
            h.arrayEvery(h.keys(c), function (d) {
              ...
              -1 == h.arrayIndexOf(a, d) && ((b[d] = c[d]), delete c[d]);
              return 1;
            });
            return b;
          };
        ...
        mixin: function (a) {
          ...
          this.paramsQueue.length &&
            ((b = h.reduce(this._reduce(h.keys(a)), {}, this.paramsQueue)),
      ...
      _initComponent: function () {
        ...
        "0" === "" + this.counterType &&
          (this.sendTitle =
            -1 === h.arrayIndexOf(this.countersNoTitle, "" + this.counterId));
      },
      ...
      sendGoal: function (a, b) {
        /[/&=?#]/.test(a)
          ...
          : this._sendGoal(a && encodeURIComponent(a), b, "goal");
      },
      ...
      _hitExt: function (a, b) {
        ...
        if (!h.isMetrikaPlayer()) {
          ...
          var r = a.browserInfo || {};
          var y =
            "undefined" !== typeof a.referrer ? a.referrer : $a.lastReferrer;
          var p = a.url || "";
          var m = {};
          a.nohit && c("nohit", 1);
          n.ar &&
            !n.onlyData &&
            ((y = null === y || "" === y ? "" : this._prepareHitUrl(y)),
            (p = this._prepareHitUrl(a.url)));
          c("forceNoRedirect", a.forceNoRedirect);
          c("page-ref", h.trim(y, mb));
          c("page-url", h.trim(p, mb));
          h.is4Bytes(a.title) && c("charset", "utf-8");
          -1 != M().hostname.search(/(?:^|\.)(?:ya|yandex)\.(?:\w+|com?\.\w+)$/)
            ? c("ut", lb)
            : "undefined" != typeof n.ut && c("ut", h.trim(n.ut, hc));
          c("exp", a.experiments);
          (f = a.vParams) &&
            this.counter &&
            f.__ym &&
            (h.isNumber(f.__ym.turbo_page) &&
              (this.counter.tp = f.__ym.turbo_page),
            h.isNumber(f.__ym.turbo_page_id) &&
              (this.counter.tpid = f.__ym.turbo_page_id));
          (!f || (h.isObject(f) && !f.__ym && !f.__ymu)) &&
            this.paramsQueue.length() &&
            h.inArray(["go", "hit", "pa"], b) &&
            (f = this.paramsQueue.mixin(f));
          f &&
            ((p = h.toJSON(f)),
            this.trimParams && p.length > ic
              ? (l = !0)
              : 7e5 < p
              ? h.warning("Too big params")
              : c("site-info", p));
      ...
      _getTechInfo: function (a, b, c, d, f, l, g, n, r, y) {
        ...
        u.isIframe() &&
          (p("ifr", "1"), p("sti", u.isSameOriginTopFrame() ? "1" : "0"));
        m.ia_document &&
          m.ia_document.shareURL &&
          m.ia_document.referrer &&
          p("iia", "1");
        p("adb", zb.getVal());
        ...
        h.random(100) ||
          p("np", ja.encode(Qa.encode(h.trim(u.getPlatform(), 100))));
        l && p("wh", "1");
        ...
        r._firstPaint || y || ((r._firstPaint = Yb()), p("fp", r._firstPaint));
        if (n) {
          g = E.get("winNameNum");
          if (!g) {
  ...
  var Ka = J.inherit({
    ...
    jc = W.inherit({
      ...
      sendPacket: function (a, b, c, d, f, l, g, n) {
        ...
        if (0 == r.indexOf("AAAAAAAAADw") && m.Error) {
          var y = Error();
          "string" == typeof y.stack &&
            new Ka({ sampling: 0.1 }).log("bad visor packet 5", 1);
        }
        a = {
          rn: h.random(),
          "page-url": b,
    ...
    tb = Wa.inherit({
      ...
      active: !1,
      _initComponent: function () {
        this.storage = new S({ counterId: this.counterId });
        this._sender = new jc({
    ...
    if (a && (d = a.childNodes)) {
      ...
      for (l = d.length; g < l; g++) {
        ...
        (f =
          "INPUT" == n.nodeName &&
          n.type &&
          "hidden" == n.type.toLocaleLowerCase()) ||
          (b && n.nodeName != b) ||
          h.mergeArrays(c, [n]);
      }
    }
  ...
  v.getDocumentScroll = function () {
    ...
    return [
      m.pageXOffset ||
        (t.documentElement && t.documentElement.scrollLeft) ||
        (a && a.scrollLeft) ||
        0,
      m.pageYOffset ||
  ...
  v.getElementSize = function (a) {
    var b;
    return a == v.getBody() || a == t.documentElement
      ? v.getDocumentSize()
    ...
    if (xb) {
      var kb = (function (a) {
        ...
        return (
          ...
          (b.i = function (a, c, l) {
            b.O(a, c) ||
              Object.defineProperty(a, c, { enumerable: !0, get: l });
          }),
          (b.s = function (a) {
            "undefined" != typeof Symbol &&
              Symbol.toStringTag &&
                  ...
                  h &&
                    (b.push(
                      "webgl unmasked vendor:" +
                        a.getParameter(h.UNMASKED_VENDOR_WEBGL)
                    ),
                    b.push(
                      "webgl unmasked renderer:" +
                        a.getParameter(h.UNMASKED_RENDERER_WEBGL)
                    ));
                } catch (k) {}
          ...
          a = (function () {
            ...
            return (
              (a.prototype.b = function () {
                ...
                for (
                  var g = b.measureText(this.o).width, h = 0, r = a.length;
                  h < r;
                  h++
                )
                  (b.font = "30px " + a[h]),
        ...
        function (a, b) {
          ...
          a = (function () {
            ...
            return (
              ...
              (a.prototype.b = function () {
                for (
                  var a = t.createElement("video"), b = [], c = 1;
                  c < this.types.length;
                  c++
                ) {
                  ...
                  for (var g = 1; g < this.v.length; g++)
                    b.push(
                      a.canPlayType(
                        this.w(
                          this.types[c] + '; codecs\x3d"' + this.v[g] + '"'
                        )
                      )
                    );
                }
        ...
        function (a, b) {
          ...
          b.hash = function (a, b) {
            ...
            for (
              ...
              (k = [
                (255 & a.charCodeAt(z + 4)) |
                  ((255 & a.charCodeAt(z + 5)) << 8) |
                  ((255 & a.charCodeAt(z + 6)) << 16) |
                  ((255 & a.charCodeAt(z + 7)) << 24),
                (255 & a.charCodeAt(z)) |
                  ((255 & a.charCodeAt(z + 1)) << 8) |
                  ((255 & a.charCodeAt(z + 2)) << 16) |
                  ((255 & a.charCodeAt(z + 3)) << 24),
              ]),
                (e = [
                  (255 & a.charCodeAt(z + 12)) |
                    ((255 & a.charCodeAt(z + 13)) << 8) |
                    ((255 & a.charCodeAt(z + 14)) << 16) |
                    ((255 & a.charCodeAt(z + 15)) << 24),
                  (255 & a.charCodeAt(z + 8)) |
                    ((255 & a.charCodeAt(z + 9)) << 8) |
                    ((255 & a.charCodeAt(z + 10)) << 16) |
                    ((255 & a.charCodeAt(z + 11)) << 24),
                ]),
                (k = f((k = c(k, B)), 31)),
                (q = d((q = f((q = g(q, c(k, H))), 27)), b)),
                (q = d(c(q, [0, 5]), [0, 1390208809])),
                (e = f((e = c(e, H)), 33)),
                (b = d((b = f((b = g(b, c(e, B))), 31)), q)),
            ...
            switch (((k = [0, 0]), (e = [0, 0]), l)) {
              ...
              case 1:
                (k = c((k = g(k, [0, a.charCodeAt(z)])), B)),
                  (q = g(q, c(f(k, 31), H)));
            }
            return (
              (q = d((q = g(q, [0, a.length])), (b = g(b, [0, a.length])))),
              (b = d(b, q)),
              (q = d((q = n(q)), (b = n(b)))),
              (b = d(b, q)),
  ...
  h.framePostMessage = function (a, b, c) {
    a &&
      ...
      a.contentWindow.postMessage(b, c);
  };
  !jb(/webkit/) && jb(/gecko/);
  var nb = {
      asyncChunk: 400,
      ...
      addAsyncItem: function (a, b, c, d, f) {
        ...
        c
          ...
          : x.getMs() - this.rest >= this.restTime && !this.timeout
          ? ((this.rest = x.getMs()), l.flushAsync())
          : this.timeout ||
      ...
      callByTimeout: function (a, b) {
        for (
          var c = x.getMs(), d = 0, f, l = (b || 0) + 1, g = 0, n = this;
    ...
    ob = W.inherit({
      ...
      sendPacket: function (a, b, c, d, f, l, g, n, r) {
        ...
        f = { et: g, w: m[0] + "x" + m[1], v: this._getVersion(), z: f, i: l };
    ...
    ab = Wa.inherit({
      ...
      append: function (a) {
        !this._data.length &&
          a &&
          a.length &&
          (this.startBufferTime = x.getSeconds());
      ...
      addData: function (a, b, c, d, f) {
        var l = 0,
          g = 1,
          n = { type: a },
          r = 0.9 * this.maxBufferSize;
        if (!this.totalSendLimit || this._totalSendedSize < this.totalSendLimit)
          if (
            ((this._v = c),
            this.wrappers.length &&
              h.arrayEvery(this.wrappers, function (c) {
                c.trigger && c.trigger(a, b);
                return 1;
              }),
            f)
          )
            this._getSize("{}"), this.append([], d);
          else {
            ...
            if (f > this.maxBufferSize)
              for (
                this._data.length && this._flush(), d = Math.ceil(c.length / r);
                l < c.length;
  ...
  try {
    K = (function (a) {
      ...
      function (a, b, c) {
        ...
        b.Long =
          (b.global.dcodeIO && b.global.dcodeIO.Long) ||
          b.global.Long ||
          b.inquire("long");
      ...
      function (a, b, c) {
        function d(a, b) {
          return RangeError(
            "index out of range: " + a.pos + " + " + (b || 1) + " \x3e " + a.len
          );
        }
        function f(a) {
          this.buf = a;
        ...
        function h() {
          ...
          if (4 < this.len - this.pos)
            for (; 5 > b; ++b) {
              if (
                ((a.hi =
                  (a.hi | ((127 & this.buf[this.pos]) << (7 * b + 3))) >>> 0),
                128 > this.buf[this.pos++])
              )
                return a;
            }
        ...
        f.prototype.skip = function (a) {
          if ("number" == typeof a) {
            ...
            do if (this.pos >= this.len) throw d(this);
      ...
      function (a, b, c) {
        ...
        q.Array !== Array &&
          (g.alloc = q.pool(g.alloc, q.Array.prototype.subarray));
        ...
        g.prototype.uint32 = function (a) {
          this.len += (this.tail = this.tail.next = new r(
            128 > (a >>>= 0)
              ? 1
              : 16384 > a
              ? 2
        ...
        g.prototype.int32 = function (a) {
          return 0 > a ? this._push(m, 10, k.fromNumber(a)) : this.uint32(a);
        };
        ...
        g.prototype.reset = function () {
          this.states
            ...
            : ((this.head = this.tail = new d(f, 0, 0)), (this.len = 0));
          return this;
        };
        ...
        g.prototype.finish = function () {
          for (
            var a = this.head.next, b = this.constructor.alloc(this.len), c = 0;
            a;

          )
            a.fn(a.val, b, c), (c += a.len), (a = a.next);
          return b;
        };
        ...
        d.prototype.rpcCall = function F(a, b, c, d, h) {
          ...
          if (g.rpcImpl)
            try {
              return g.rpcImpl(
                a,
                b[g.requestDelimited ? "encodeDelimited" : "encode"](
                  d
                ).finish(),
                function (b, e) {
                  ...
                  if (null !== e) {
                    if (!(e instanceof c))
                      try {
                        e = c[
                          g.responseDelimited ? "decodeDelimited" : "decode"
                        ](e);
                      } catch (B) {
      ...
      function (a, b, c) {
        ...
        var r =
          ...
          "set" === n.prototype.set.name
            ? function (a, b, c) {
                b.set(a, c);
              }
            : function (a, b, c) {
                if (a.copy) a.copy(b, c, 0, a.length);
                else for (var d = 0; d < a.length; ) b[c++] = a[d++];
              };
      ...
      function (a, b, c) {
        ...
        d.prototype.toLong = function (a) {
          return f.Long
            ? new f.Long(0 | this.lo, 0 | this.hi, !!a)
          ...
          for (var b = 0, c, d = 0; d < a.length; ++d)
            (c = a.charCodeAt(d)),
              128 > c
                ...
                : 2048 > c
                ? (b += 2)
                : 55296 == (64512 & c) && 56320 == (64512 & a.charCodeAt(d + 1))
                ? (++d, (b += 4))
                : (b += 3);
          return b;
        };
            ...
            (d = a[b++]),
              128 > d
                ...
                ? ((d =
                  ...
                  (h[l++] = 56320 + (1023 & d)))
                : (h[l++] =
                    ((15 & d) << 12) | ((63 & a[b++]) << 6) | (63 & a[b++])),
              8191 < l &&
                ((f || (f = [])).push(String.fromCharCode.apply(String, h)),
                (l = 0));
          return f
            ? (l && f.push(String.fromCharCode.apply(String, h.slice(0, l))),
              f.join(""))
            : String.fromCharCode.apply(String, h.slice(0, l));
        };
            ...
            (d = a.charCodeAt(l)),
              128 > d
                ...
                : (2048 > d
                    ? (b[c++] = (d >> 6) | 192)
                    : (55296 == (64512 & d) &&
                      56320 == (64512 & (f = a.charCodeAt(l + 1)))
                        ? ((d = 65536 + ((1023 & d) << 10) + (1023 & f)),
                          ++l,
                          (b[c++] = (d >> 18) | 240),
                          (b[c++] = ((d >> 12) & 63) | 128))
                        : (b[c++] = (d >> 12) | 224),
                  ...
                  if (0 === b) a(0 < 1 / b ? 0 : 2147483648, c, e);
                    ...
                    a(
                      ((d << 31) |
                        ((k + 127) << 23) |
                        (8388607 &
                          Math.round(b * Math.pow(2, -k) * 8388608))) >>>
                        0,
                      c,
                      e
                    );
      ...
      function (a, b, c) {
        ...
        b.encode = function (a, b, c) {
          for (var f, g = null, h = [], l = 0, q = 0; b < c; ) {
            ...
            8191 < l &&
              ((g || (g = [])).push(String.fromCharCode.apply(String, h)),
              (l = 0));
          }
          q && ((h[l++] = d[f]), (h[l++] = 61), 1 === q && (h[l++] = 61));
          return g
            ? (l && g.push(String.fromCharCode.apply(String, h.slice(0, l))),
              g.join(""))
            : String.fromCharCode.apply(String, h.slice(0, l));
        };
      ...
      function (a, b, c) {
        a.exports = function (a, b) {
          for (
            var c = Array(arguments.length - 1), d = 0, f = 2, h = !0;
            f < arguments.length;
                ...
                a.proto = (function () {
                  ...
                  a.BufferWrapper = (function () {
                    ...
                    a.encode = function (a, b) {
                      ...
                      if (null != a.buffer && a.buffer.length)
                        for (var c = 0; c < a.buffer.length; ++c)
                          g.ru.yandex.metrika.wv2.proto.Buffer.encode(
                            a.buffer[c],
                            b.uint32(10).fork()
                          ).ldelim();
                      return b;
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.BufferWrapper();
                        a.pos < c;
                        ...
                        switch (k >>> 3) {
                          case 1:
                            ...
                            e.buffer.push(
                              g.ru.yandex.metrika.wv2.proto.Buffer.decode(
                                a,
                                a.uint32()
                              )
                            );
                  ...
                  a.Buffer = (function () {
                    ...
                    a.encode = function (a, b) {
                      b || (b = f.create());
                      null != a.stamp &&
                        Object.hasOwnProperty.call(a, "stamp") &&
                        b.uint32(8).int32(a.stamp);
                      null != a.data &&
                        Object.hasOwnProperty.call(a, "data") &&
                        g.ru.yandex.metrika.wv2.proto.Wrapper.encode(
                          a.data,
                          b.uint32(18).fork()
                        ).ldelim();
                      null != a.page &&
                        Object.hasOwnProperty.call(a, "page") &&
                        b.uint32(24).int32(a.page);
                      null != a.chunk &&
                        Object.hasOwnProperty.call(a, "chunk") &&
                        b.uint32(34).bytes(a.chunk);
                      null != a.end &&
                        Object.hasOwnProperty.call(a, "end") &&
                        b.uint32(40).bool(a.end);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.Buffer();
                        a.pos < c;
                        ...
                        switch (k >>> 3) {
                          case 1:
                            ...
                            break;
                          case 2:
                            e.data = g.ru.yandex.metrika.wv2.proto.Wrapper.decode(
                              a,
                              a.uint32()
                            );
                            break;
                  ...
                  a.Wrapper = (function () {
                    ...
                    Object.defineProperty(a.prototype, "data", {
                      get: h.oneOfGetter(
                        (b = "page mutation event articleInfo publishersHeader activity".split(
                          " "
                        ))
                      ),
                      set: h.oneOfSetter(b),
                    ...
                    a.encode = function (a, b) {
                      ...
                      null != a.page &&
                        Object.hasOwnProperty.call(a, "page") &&
                        g.ru.yandex.metrika.wv2.proto.Page.encode(
                          a.page,
                          b.uint32(10).fork()
                        ).ldelim();
                      null != a.mutation &&
                        Object.hasOwnProperty.call(a, "mutation") &&
                        g.ru.yandex.metrika.wv2.proto.Mutation.encode(
                          a.mutation,
                          b.uint32(18).fork()
                        ).ldelim();
                      null != a.event &&
                        Object.hasOwnProperty.call(a, "event") &&
                        g.ru.yandex.metrika.wv2.proto.Event.encode(
                          a.event,
                          b.uint32(26).fork()
                        ).ldelim();
                      null != a.articleInfo &&
                        Object.hasOwnProperty.call(a, "articleInfo") &&
                        g.ru.yandex.metrika.wv2.proto.ArticleInfo.encode(
                          a.articleInfo,
                          b.uint32(34).fork()
                        ).ldelim();
                      null != a.publishersHeader &&
                        Object.hasOwnProperty.call(a, "publishersHeader") &&
                        g.ru.yandex.metrika.wv2.proto.PublishersHeader.encode(
                          a.publishersHeader,
                          b.uint32(42).fork()
                        ).ldelim();
                      null != a.activity &&
                        Object.hasOwnProperty.call(a, "activity") &&
                        b.uint32(48).uint32(a.activity);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.Wrapper();
                        a.pos < c;
                        ...
                        switch (k >>> 3) {
                          case 1:
                            e.page = g.ru.yandex.metrika.wv2.proto.Page.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 2:
                            e.mutation = g.ru.yandex.metrika.wv2.proto.Mutation.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 3:
                            e.event = g.ru.yandex.metrika.wv2.proto.Event.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 4:
                            e.articleInfo = g.ru.yandex.metrika.wv2.proto.ArticleInfo.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 5:
                            e.publishersHeader = g.ru.yandex.metrika.wv2.proto.PublishersHeader.decode(
                              a,
                              a.uint32()
                            );
                            break;
                  ...
                  a.Page = (function () {
                    ...
                    a.prototype.tabId = "";
                    a.prototype.recordStamp = h.Long
                    ...
                    a.encode = function (a, b) {
                      b || (b = f.create());
                      null != a.meta &&
                        Object.hasOwnProperty.call(a, "meta") &&
                        g.ru.yandex.metrika.wv2.proto.Page.Meta.encode(
                          a.meta,
                          b.uint32(10).fork()
                        ).ldelim();
                      if (null != a.content && a.content.length)
                        for (var c = 0; c < a.content.length; ++c)
                          g.ru.yandex.metrika.wv2.proto.Page.Content.encode(
                            a.content[c],
                            b.uint32(18).fork()
                          ).ldelim();
                      null != a.frameId &&
                        Object.hasOwnProperty.call(a, "frameId") &&
                        b.uint32(24).sint32(a.frameId);
                      null != a.tabId &&
                        Object.hasOwnProperty.call(a, "tabId") &&
                        b.uint32(34).string(a.tabId);
                      null != a.recordStamp &&
                        Object.hasOwnProperty.call(a, "recordStamp") &&
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.Page();
                        a.pos < c;
                        ...
                        switch (k >>> 3) {
                          case 1:
                            e.meta = g.ru.yandex.metrika.wv2.proto.Page.Meta.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 2:
                            ...
                            e.content.push(
                              g.ru.yandex.metrika.wv2.proto.Page.Content.decode(
                                a,
                                a.uint32()
                              )
                            );
                    ...
                    a.Box = (function () {
                      ...
                      a.encode = function (a, b) {
                        b || (b = f.create());
                        null != a.width &&
                          Object.hasOwnProperty.call(a, "width") &&
                          b.uint32(8).int32(a.width);
                        null != a.height &&
                          Object.hasOwnProperty.call(a, "height") &&
                          b.uint32(16).int32(a.height);
                        return b;
                      };
                      a.decode = function (a, b) {
                        a instanceof d || (a = d.create(a));
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.Page.Box();
                          a.pos < c;
                    ...
                    a.Location = (function () {
                      ...
                      a.encode = function (a, b) {
                        b || (b = f.create());
                        null != a.host &&
                          Object.hasOwnProperty.call(a, "host") &&
                          b.uint32(10).string(a.host);
                        null != a.protocol &&
                          Object.hasOwnProperty.call(a, "protocol") &&
                          b.uint32(18).string(a.protocol);
                        null != a.path &&
                          Object.hasOwnProperty.call(a, "path") &&
                          b.uint32(26).string(a.path);
                        return b;
                      };
                      a.decode = function (a, b) {
                        a instanceof d || (a = d.create(a));
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.Page.Location();
                          a.pos < c;
                    ...
                    a.Scroll = (function () {
                      ...
                      a.encode = function (a, b) {
                        b || (b = f.create());
                        null != a.target &&
                          Object.hasOwnProperty.call(a, "target") &&
                      ...
                      a.decode = function (a, b) {
                        ...
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.Page.Scroll();
                          a.pos < c;
                    ...
                    a.Meta = (function () {
                      ...
                      a.encode = function (a, b) {
                        b || (b = f.create());
                        null != a.doctype &&
                          Object.hasOwnProperty.call(a, "doctype") &&
                          b.uint32(10).string(a.doctype);
                        null != a.title &&
                          Object.hasOwnProperty.call(a, "title") &&
                          b.uint32(18).string(a.title);
                        null != a.address &&
                          Object.hasOwnProperty.call(a, "address") &&
                          b.uint32(26).string(a.address);
                        null != a.ua &&
                          Object.hasOwnProperty.call(a, "ua") &&
                          b.uint32(34).string(a.ua);
                        null != a.referrer &&
                          Object.hasOwnProperty.call(a, "referrer") &&
                          b.uint32(42).string(a.referrer);
                        null != a.base &&
                          Object.hasOwnProperty.call(a, "base") &&
                          b.uint32(50).string(a.base);
                        null != a.hasBase &&
                          Object.hasOwnProperty.call(a, "hasBase") &&
                          b.uint32(56).bool(a.hasBase);
                        null != a.screen &&
                          Object.hasOwnProperty.call(a, "screen") &&
                          g.ru.yandex.metrika.wv2.proto.Page.Box.encode(
                            a.screen,
                            b.uint32(66).fork()
                          ).ldelim();
                        null != a.viewport &&
                          Object.hasOwnProperty.call(a, "viewport") &&
                          g.ru.yandex.metrika.wv2.proto.Page.Box.encode(
                            a.viewport,
                            b.uint32(74).fork()
                          ).ldelim();
                        null != a.location &&
                          Object.hasOwnProperty.call(a, "location") &&
                          g.ru.yandex.metrika.wv2.proto.Page.Location.encode(
                            a.location,
                            b.uint32(82).fork()
                          ).ldelim();
                        if (null != a.initialScroll && a.initialScroll.length)
                          for (var c = 0; c < a.initialScroll.length; ++c)
                            g.ru.yandex.metrika.wv2.proto.Page.Scroll.encode(
                              a.initialScroll[c],
                              b.uint32(90).fork()
                            ).ldelim();
                        return b;
                      ...
                      a.decode = function (a, b) {
                        ...
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.Page.Meta();
                          a.pos < c;
                          ...
                          switch (k >>> 3) {
                            ...
                            case 7:
                              ...
                              break;
                            case 8:
                              e.screen = g.ru.yandex.metrika.wv2.proto.Page.Box.decode(
                                a,
                                a.uint32()
                              );
                              break;
                            case 9:
                              e.viewport = g.ru.yandex.metrika.wv2.proto.Page.Box.decode(
                                a,
                                a.uint32()
                              );
                              break;
                            case 10:
                              e.location = g.ru.yandex.metrika.wv2.proto.Page.Location.decode(
                                a,
                                a.uint32()
                              );
                              break;
                            case 11:
                              (e.initialScroll && e.initialScroll.length) ||
                                (e.initialScroll = []);
                              e.initialScroll.push(
                                g.ru.yandex.metrika.wv2.proto.Page.Scroll.decode(
                                  a,
                                  a.uint32()
                                )
                              );
                    ...
                    a.Content = (function () {
                      ...
                      a.encode = function (a, b) {
                        ...
                        null != a.name &&
                          Object.hasOwnProperty.call(a, "name") &&
                          b.uint32(18).string(a.name);
                        if (
                          null != a.attributes &&
                          Object.hasOwnProperty.call(a, "attributes")
                        )
                          for (
                            var c = Object.keys(a.attributes), d = 0;
                            d < c.length;
                            ++d
                          )
                            b.uint32(26)
                              ...
                              .string(c[d])
                              .uint32(18)
                              .string(a.attributes[c[d]])
                              .ldelim();
                        null != a.parent &&
                          Object.hasOwnProperty.call(a, "parent") &&
                          b.uint32(32).int32(a.parent);
                        null != a.content &&
                          Object.hasOwnProperty.call(a, "content") &&
                          b.uint32(42).string(a.content);
                        null != a.next &&
                          Object.hasOwnProperty.call(a, "next") &&
                          b.uint32(48).int32(a.next);
                        null != a.prev &&
                          Object.hasOwnProperty.call(a, "prev") &&
                          b.uint32(56).int32(a.prev);
                        null != a.hidden &&
                          Object.hasOwnProperty.call(a, "hidden") &&
                          b.uint32(64).bool(a.hidden);
                        return b;
                      };
                      a.decode = function (a, b) {
                        a instanceof d || (a = d.create(a));
                        for (
                          var c,
                            e = void 0 === b ? a.len : a.pos + b,
                            k = new g.ru.yandex.metrika.wv2.proto.Page.Content();
                          a.pos < e;

                        )
                          switch (((c = a.uint32()), c >>> 3)) {
                            case 1:
                              k.id = a.int32();
                              break;
                            case 2:
                  ...
                  a.Mutation = (function () {
                    ...
                    a.encode = function (a, b) {
                      ...
                      null != a.stamp &&
                        Object.hasOwnProperty.call(a, "stamp") &&
                        b.uint32(16).int32(a.stamp);
                      null != a.meta &&
                        Object.hasOwnProperty.call(a, "meta") &&
                        g.ru.yandex.metrika.wv2.proto.Mutation.Meta.encode(
                          a.meta,
                          b.uint32(26).fork()
                        ).ldelim();
                      null != a.frameId &&
                        Object.hasOwnProperty.call(a, "frameId") &&
                        b.uint32(32).sint32(a.frameId);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.Mutation();
                        a.pos < c;
                        ...
                        switch (k >>> 3) {
                          ...
                          case 2:
                            ...
                            break;
                          case 3:
                            e.meta = g.ru.yandex.metrika.wv2.proto.Mutation.Meta.decode(
                              a,
                              a.uint32()
                            );
                            break;
                    ...
                    a.Delete = (function () {
                      ...
                      a.encode = function (a, b) {
                        ...
                        null != a.id &&
                          ...
                          b.uint32(8).int32(a.id);
                        null != a.pr &&
                          Object.hasOwnProperty.call(a, "pr") &&
                          b.uint32(16).int32(a.pr);
                        null != a.nx &&
                          Object.hasOwnProperty.call(a, "nx") &&
                          b.uint32(24).int32(a.nx);
                        null != a.pa &&
                          Object.hasOwnProperty.call(a, "pa") &&
                          b.uint32(32).int32(a.pa);
                        null != a.i &&
                          Object.hasOwnProperty.call(a, "i") &&
                          b.uint32(40).int32(a.i);
                        return b;
                      };
                      a.decode = function (a, b) {
                        a instanceof d || (a = d.create(a));
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.Mutation.Delete();
                          a.pos < c;
                    ...
                    a.Add = (function () {
                      ...
                      a.encode = function (a, b) {
                        ...
                        null != a.id &&
                          ...
                          b.uint32(8).int32(a.id);
                        null != a.nm &&
                          Object.hasOwnProperty.call(a, "nm") &&
                          b.uint32(18).string(a.nm);
                        null != a.pa &&
                          Object.hasOwnProperty.call(a, "pa") &&
                          b.uint32(24).int32(a.pa);
                        null != a.ns &&
                          Object.hasOwnProperty.call(a, "ns") &&
                          b.uint32(34).string(a.ns);
                        null != a.pr &&
                          Object.hasOwnProperty.call(a, "pr") &&
                          b.uint32(40).int32(a.pr);
                        if (null != a.at && Object.hasOwnProperty.call(a, "at"))
                          for (
                            var c = Object.keys(a.at), d = 0;
                            d < c.length;
                            ++d
                          )
                            b.uint32(50)
                              ...
                              .ldelim();
                        null != a.ct &&
                          Object.hasOwnProperty.call(a, "ct") &&
                          b.uint32(58).string(a.ct);
                        null != a.nx &&
                          Object.hasOwnProperty.call(a, "nx") &&
                          b.uint32(64).int32(a.nx);
                        null != a.i &&
                          Object.hasOwnProperty.call(a, "i") &&
                          b.uint32(72).int32(a.i);
                        null != a.h &&
                          Object.hasOwnProperty.call(a, "h") &&
                      ...
                      a.decode = function (a, b) {
                        ...
                        for (
                          var c,
                            e = void 0 === b ? a.len : a.pos + b,
                            k = new g.ru.yandex.metrika.wv2.proto.Mutation.Add();
                          a.pos < e;
                    ...
                    a.BeforeAfter = (function () {
                      ...
                      a.encode = function (a, b) {
                        ...
                        null != a.o &&
                          ...
                          b.uint32(10).string(a.o);
                        null != a.n &&
                          Object.hasOwnProperty.call(a, "n") &&
                          b.uint32(18).string(a.n);
                        null != a.r &&
                          Object.hasOwnProperty.call(a, "r") &&
                          b.uint32(24).bool(a.r);
                        return b;
                      };
                      a.decode = function (a, b) {
                        a instanceof d || (a = d.create(a));
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.Mutation.BeforeAfter();
                          a.pos < c;
                    ...
                    a.AttributeChange = (function () {
                        ...
                        if (null != a.at && Object.hasOwnProperty.call(a, "at"))
                          for (
                            ...
                            b.uint32(18).fork().uint32(10).string(c[d]),
                              g.ru.yandex.metrika.wv2.proto.Mutation.BeforeAfter.encode(
                                a.at[c[d]],
                                b.uint32(18).fork()
                              )
                                .ldelim()
                      ...
                      a.decode = function (a, b) {
                        ...
                        for (
                          var c,
                            e = void 0 === b ? a.len : a.pos + b,
                            k = new g.ru.yandex.metrika.wv2.proto.Mutation.AttributeChange();
                          a.pos < e;
                          ...
                          switch (((c = a.uint32()), c >>> 3)) {
                            ...
                            case 2:
                              ...
                              k.at[
                                c
                              ] = g.ru.yandex.metrika.wv2.proto.Mutation.BeforeAfter.decode(
                                a,
                                a.uint32()
                              );
                              break;
                    ...
                    a.TextChange = (function () {
                      ...
                      a.decode = function (a, b) {
                        ...
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.Mutation.TextChange();
                          a.pos < c;
                          ...
                          switch (k >>> 3) {
                            case 1:
                              ...
                              break;
                            case 2:
                              e.ct = g.ru.yandex.metrika.wv2.proto.Mutation.BeforeAfter.decode(
                                a,
                                a.uint32()
                              );
                              break;
                    ...
                    a.Changes = (function () {
                      ...
                      a.encode = function (a, b) {
                        ...
                        if (null != a.a && a.a.length)
                          for (var c = 0; c < a.a.length; ++c)
                            g.ru.yandex.metrika.wv2.proto.Mutation.Delete.encode(
                              a.a[c],
                              b.uint32(10).fork()
                            ).ldelim();
                        if (null != a.b && a.b.length)
                          for (c = 0; c < a.b.length; ++c)
                            g.ru.yandex.metrika.wv2.proto.Mutation.Add.encode(
                              a.b[c],
                              b.uint32(18).fork()
                            ).ldelim();
                        if (null != a.c && a.c.length)
                          for (c = 0; c < a.c.length; ++c)
                            g.ru.yandex.metrika.wv2.proto.Mutation.AttributeChange.encode(
                              a.c[c],
                              b.uint32(26).fork()
                            ).ldelim();
                        if (null != a.d && a.d.length)
                          for (c = 0; c < a.d.length; ++c)
                            g.ru.yandex.metrika.wv2.proto.Mutation.TextChange.encode(
                              a.d[c],
                              b.uint32(34).fork()
                            ).ldelim();
                        return b;
                      ...
                      a.decode = function (a, b) {
                        ...
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.Mutation.Changes();
                          a.pos < c;
                          ...
                          switch (k >>> 3) {
                            case 1:
                              (e.a && e.a.length) || (e.a = []);
                              e.a.push(
                                g.ru.yandex.metrika.wv2.proto.Mutation.Delete.decode(
                                  a,
                                  a.uint32()
                                )
                              );
                            ...
                            case 2:
                              (e.b && e.b.length) || (e.b = []);
                              e.b.push(
                                g.ru.yandex.metrika.wv2.proto.Mutation.Add.decode(
                                  a,
                                  a.uint32()
                                )
                              );
                            ...
                            case 3:
                              (e.c && e.c.length) || (e.c = []);
                              e.c.push(
                                g.ru.yandex.metrika.wv2.proto.Mutation.AttributeChange.decode(
                                  a,
                                  a.uint32()
                                )
                              );
                            ...
                            case 4:
                              (e.d && e.d.length) || (e.d = []);
                              e.d.push(
                                g.ru.yandex.metrika.wv2.proto.Mutation.TextChange.decode(
                                  a,
                                  a.uint32()
                                )
                              );
                    ...
                    a.Meta = (function () {
                      ...
                      a.encode = function (a, b) {
                        ...
                        null != a.index &&
                          ...
                          b.uint32(8).int32(a.index);
                        if (null != a.changes && a.changes.length)
                          for (var c = 0; c < a.changes.length; ++c)
                            g.ru.yandex.metrika.wv2.proto.Mutation.Changes.encode(
                              a.changes[c],
                              b.uint32(18).fork()
                            ).ldelim();
                        return b;
                      ...
                      a.decode = function (a, b) {
                        ...
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.Mutation.Meta();
                          a.pos < c;
                          ...
                          switch (k >>> 3) {
                            ...
                            case 2:
                              (e.changes && e.changes.length) ||
                                (e.changes = []);
                              e.changes.push(
                                g.ru.yandex.metrika.wv2.proto.Mutation.Changes.decode(
                                  a,
                                  a.uint32()
                                )
                              );
                  ...
                  a.Event = (function () {
                    ...
                    Object.defineProperty(a.prototype, "meta", {
                      get: h.oneOfGetter(
                        (b = "mouseEvent scrollEvent windowEvent selectionEvent changeEvent touchEvent methodEvent propertyEvent zoomEvent resizeEvent keystrokesEvent deviceRotationEvent fatalErrorEvent hashchangeEvent".split(
                          " "
                        ))
                      ),
                      set: h.oneOfSetter(b),
                    ...
                    a.encode = function (a, b) {
                      b || (b = f.create());
                      null != a.type &&
                        Object.hasOwnProperty.call(a, "type") &&
                        b.uint32(8).int32(a.type);
                      null != a.target &&
                        Object.hasOwnProperty.call(a, "target") &&
                        b.uint32(16).sint32(a.target);
                      null != a.frameId &&
                        Object.hasOwnProperty.call(a, "frameId") &&
                        b.uint32(24).sint32(a.frameId);
                      null != a.mouseEvent &&
                        Object.hasOwnProperty.call(a, "mouseEvent") &&
                        g.ru.yandex.metrika.wv2.proto.MouseEvent.encode(
                          a.mouseEvent,
                          b.uint32(34).fork()
                        ).ldelim();
                      null != a.scrollEvent &&
                        Object.hasOwnProperty.call(a, "scrollEvent") &&
                        g.ru.yandex.metrika.wv2.proto.ScrollEvent.encode(
                          a.scrollEvent,
                          b.uint32(42).fork()
                        ).ldelim();
                      null != a.windowEvent &&
                        Object.hasOwnProperty.call(a, "windowEvent") &&
                        g.ru.yandex.metrika.wv2.proto.WindowEvent.encode(
                          a.windowEvent,
                          b.uint32(50).fork()
                        ).ldelim();
                      null != a.selectionEvent &&
                        Object.hasOwnProperty.call(a, "selectionEvent") &&
                        g.ru.yandex.metrika.wv2.proto.SelectionEvent.encode(
                          a.selectionEvent,
                          b.uint32(58).fork()
                        ).ldelim();
                      null != a.changeEvent &&
                        Object.hasOwnProperty.call(a, "changeEvent") &&
                        g.ru.yandex.metrika.wv2.proto.ChangeEvent.encode(
                          a.changeEvent,
                          b.uint32(66).fork()
                        ).ldelim();
                      null != a.touchEvent &&
                        Object.hasOwnProperty.call(a, "touchEvent") &&
                        g.ru.yandex.metrika.wv2.proto.TouchEvent.encode(
                          a.touchEvent,
                          b.uint32(74).fork()
                        ).ldelim();
                      null != a.methodEvent &&
                        Object.hasOwnProperty.call(a, "methodEvent") &&
                        g.ru.yandex.metrika.wv2.proto.MethodEvent.encode(
                          a.methodEvent,
                          b.uint32(82).fork()
                        ).ldelim();
                      null != a.propertyEvent &&
                        Object.hasOwnProperty.call(a, "propertyEvent") &&
                        g.ru.yandex.metrika.wv2.proto.PropertyEvent.encode(
                          a.propertyEvent,
                          b.uint32(90).fork()
                        ).ldelim();
                      null != a.zoomEvent &&
                        Object.hasOwnProperty.call(a, "zoomEvent") &&
                        g.ru.yandex.metrika.wv2.proto.ZoomEvent.encode(
                          a.zoomEvent,
                          b.uint32(98).fork()
                        ).ldelim();
                      null != a.resizeEvent &&
                        Object.hasOwnProperty.call(a, "resizeEvent") &&
                        g.ru.yandex.metrika.wv2.proto.ResizeEvent.encode(
                          a.resizeEvent,
                          b.uint32(106).fork()
                        ).ldelim();
                      null != a.keystrokesEvent &&
                        Object.hasOwnProperty.call(a, "keystrokesEvent") &&
                        g.ru.yandex.metrika.wv2.proto.KeystrokesEvent.encode(
                          a.keystrokesEvent,
                          b.uint32(114).fork()
                        ).ldelim();
                      null != a.deviceRotationEvent &&
                        Object.hasOwnProperty.call(a, "deviceRotationEvent") &&
                        g.ru.yandex.metrika.wv2.proto.DeviceRotationEvent.encode(
                          a.deviceRotationEvent,
                          b.uint32(122).fork()
                        ).ldelim();
                      null != a.fatalErrorEvent &&
                        Object.hasOwnProperty.call(a, "fatalErrorEvent") &&
                        g.ru.yandex.metrika.wv2.proto.FatalErrorEvent.encode(
                          a.fatalErrorEvent,
                          b.uint32(130).fork()
                        ).ldelim();
                      null != a.hashchangeEvent &&
                        Object.hasOwnProperty.call(a, "hashchangeEvent") &&
                        g.ru.yandex.metrika.wv2.proto.HashchangeEvent.encode(
                          a.hashchangeEvent,
                          b.uint32(138).fork()
                        ).ldelim();
                      return b;
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.Event();
                        a.pos < c;
                        ...
                        switch (k >>> 3) {
                          ...
                          case 3:
                            ...
                            break;
                          case 4:
                            e.mouseEvent = g.ru.yandex.metrika.wv2.proto.MouseEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 5:
                            e.scrollEvent = g.ru.yandex.metrika.wv2.proto.ScrollEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 6:
                            e.windowEvent = g.ru.yandex.metrika.wv2.proto.WindowEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 7:
                            e.selectionEvent = g.ru.yandex.metrika.wv2.proto.SelectionEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 8:
                            e.changeEvent = g.ru.yandex.metrika.wv2.proto.ChangeEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 9:
                            e.touchEvent = g.ru.yandex.metrika.wv2.proto.TouchEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 10:
                            e.methodEvent = g.ru.yandex.metrika.wv2.proto.MethodEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 11:
                            e.propertyEvent = g.ru.yandex.metrika.wv2.proto.PropertyEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 12:
                            e.zoomEvent = g.ru.yandex.metrika.wv2.proto.ZoomEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 13:
                            e.resizeEvent = g.ru.yandex.metrika.wv2.proto.ResizeEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 14:
                            e.keystrokesEvent = g.ru.yandex.metrika.wv2.proto.KeystrokesEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 15:
                            e.deviceRotationEvent = g.ru.yandex.metrika.wv2.proto.DeviceRotationEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 16:
                            e.fatalErrorEvent = g.ru.yandex.metrika.wv2.proto.FatalErrorEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 17:
                            e.hashchangeEvent = g.ru.yandex.metrika.wv2.proto.HashchangeEvent.decode(
                              a,
                              a.uint32()
                            );
                            break;
                  ...
                  a.MouseEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      b || (b = f.create());
                      null != a.x &&
                        Object.hasOwnProperty.call(a, "x") &&
                        b.uint32(8).int32(a.x);
                      null != a.y &&
                        Object.hasOwnProperty.call(a, "y") &&
                        b.uint32(16).int32(a.y);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.MouseEvent();
                        a.pos < c;
                  ...
                  a.ScrollEvent = (function () {
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.ScrollEvent();
                        a.pos < c;
                  ...
                  a.WindowEvent = (function () {
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.WindowEvent();
                        a.pos < c;
                  ...
                  a.SelectionEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      b || (b = f.create());
                      null != a.start &&
                        Object.hasOwnProperty.call(a, "start") &&
                        b.uint32(8).int32(a.start);
                      null != a.end &&
                        Object.hasOwnProperty.call(a, "end") &&
                        b.uint32(16).int32(a.end);
                      null != a.startNode &&
                        Object.hasOwnProperty.call(a, "startNode") &&
                        b.uint32(24).int32(a.startNode);
                      null != a.endNode &&
                        Object.hasOwnProperty.call(a, "endNode") &&
                        b.uint32(32).int32(a.endNode);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.SelectionEvent();
                        a.pos < c;
                  ...
                  a.ChangeEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      ...
                      null != a.value &&
                        ...
                        b.uint32(10).string(a.value);
                      null != a.checked &&
                        Object.hasOwnProperty.call(a, "checked") &&
                        b.uint32(16).bool(a.checked);
                      null != a.hidden &&
                        Object.hasOwnProperty.call(a, "hidden") &&
                        b.uint32(24).bool(a.hidden);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.ChangeEvent();
                        a.pos < c;
                  ...
                  a.TouchEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      ...
                      if (null != a.touches && a.touches.length)
                        for (var c = 0; c < a.touches.length; ++c)
                          g.ru.yandex.metrika.wv2.proto.TouchEvent.SubMeta.encode(
                            a.touches[c],
                            b.uint32(10).fork()
                          ).ldelim();
                      return b;
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.TouchEvent();
                        a.pos < c;
                        ...
                        switch (k >>> 3) {
                          case 1:
                            ...
                            e.touches.push(
                              g.ru.yandex.metrika.wv2.proto.TouchEvent.SubMeta.decode(
                                a,
                                a.uint32()
                              )
                            );
                    ...
                    a.SubMeta = (function () {
                      ...
                      a.encode = function (a, b) {
                        ...
                        null != a.id &&
                          Object.hasOwnProperty.call(a, "id") &&
                          b.uint32(10).string(a.id);
                        null != a.x &&
                          Object.hasOwnProperty.call(a, "x") &&
                          b.uint32(21)["float"](a.x);
                        null != a.y &&
                          Object.hasOwnProperty.call(a, "y") &&
                          b.uint32(29)["float"](a.y);
                        null != a.force &&
                          Object.hasOwnProperty.call(a, "force") &&
                          b.uint32(37)["float"](a.force);
                        return b;
                      };
                      a.decode = function (a, b) {
                        a instanceof d || (a = d.create(a));
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.TouchEvent.SubMeta();
                          a.pos < c;
                  ...
                  a.ZoomEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      b || (b = f.create());
                      null != a.zoomFrom &&
                        Object.hasOwnProperty.call(a, "zoomFrom") &&
                        g.ru.yandex.metrika.wv2.proto.ZoomEvent.ZoomPoint.encode(
                          a.zoomFrom,
                          b.uint32(10).fork()
                        ).ldelim();
                      null != a.zoomTo &&
                        Object.hasOwnProperty.call(a, "zoomTo") &&
                        g.ru.yandex.metrika.wv2.proto.ZoomEvent.ZoomPoint.encode(
                          a.zoomTo,
                          b.uint32(18).fork()
                        ).ldelim();
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.ZoomEvent();
                        a.pos < c;
                        ...
                        switch (k >>> 3) {
                          case 1:
                            e.zoomFrom = g.ru.yandex.metrika.wv2.proto.ZoomEvent.ZoomPoint.decode(
                              a,
                              a.uint32()
                            );
                            break;
                          case 2:
                            e.zoomTo = g.ru.yandex.metrika.wv2.proto.ZoomEvent.ZoomPoint.decode(
                              a,
                              a.uint32()
                            );
                            break;
                    ...
                    a.ZoomPoint = (function () {
                      ...
                      a.encode = function (a, b) {
                        b || (b = f.create());
                        null != a.level &&
                          Object.hasOwnProperty.call(a, "level") &&
                          b.uint32(13)["float"](a.level);
                        null != a.x &&
                          Object.hasOwnProperty.call(a, "x") &&
                          b.uint32(16).int32(a.x);
                        null != a.y &&
                          Object.hasOwnProperty.call(a, "y") &&
                          b.uint32(24).int32(a.y);
                        return b;
                      };
                      a.decode = function (a, b) {
                        a instanceof d || (a = d.create(a));
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.ZoomEvent.ZoomPoint();
                          a.pos < c;
                  ...
                  a.ResizeEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      ...
                      null != a.pageWidth &&
                        ...
                        b.uint32(24).int32(a.pageWidth);
                      null != a.pageHeight &&
                        Object.hasOwnProperty.call(a, "pageHeight") &&
                        b.uint32(32).int32(a.pageHeight);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.ResizeEvent();
                        a.pos < c;
                  ...
                  a.MethodEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      b || (b = f.create());
                      null != a.method &&
                        Object.hasOwnProperty.call(a, "method") &&
                        b.uint32(10).string(a.method);
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.MethodEvent();
                        a.pos < c;
                  ...
                  a.PropertyEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      b || (b = f.create());
                      null != a.property &&
                        Object.hasOwnProperty.call(a, "property") &&
                        b.uint32(10).string(a.property);
                      null != a.value &&
                        Object.hasOwnProperty.call(a, "value") &&
                        b.uint32(18).string(a.value);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.PropertyEvent();
                        a.pos < c;
                  ...
                  a.KeystrokesEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      ...
                      if (null != a.keystrokes && a.keystrokes.length)
                        for (var c = 0; c < a.keystrokes.length; ++c)
                          g.ru.yandex.metrika.wv2.proto.KeystrokesEvent.KeystrokeEvent.encode(
                            a.keystrokes[c],
                            b.uint32(10).fork()
                          ).ldelim();
                      return b;
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.KeystrokesEvent();
                        a.pos < c;
                        ...
                        switch (f >>> 3) {
                          case 1:
                            (e.keystrokes && e.keystrokes.length) ||
                              (e.keystrokes = []);
                            e.keystrokes.push(
                              g.ru.yandex.metrika.wv2.proto.KeystrokesEvent.KeystrokeEvent.decode(
                                a,
                                a.uint32()
                              )
                            );
                    ...
                    a.KeystrokeEvent = (function () {
                      ...
                      a.encode = function (a, b) {
                        ...
                        null != a.key &&
                          ...
                          b.uint32(18).string(a.key);
                        null != a.isMeta &&
                          Object.hasOwnProperty.call(a, "isMeta") &&
                          b.uint32(24).bool(a.isMeta);
                        null != a.modifier &&
                          Object.hasOwnProperty.call(a, "modifier") &&
                          b.uint32(34).string(a.modifier);
                        return b;
                      };
                      a.decode = function (a, b) {
                        a instanceof d || (a = d.create(a));
                        for (
                          var c = void 0 === b ? a.len : a.pos + b,
                            e = new g.ru.yandex.metrika.wv2.proto.KeystrokesEvent.KeystrokeEvent();
                          a.pos < c;
                  ...
                  a.DeviceRotationEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      ...
                      null != a.height &&
                        ...
                        b.uint32(16).int32(a.height);
                      null != a.orientation &&
                        Object.hasOwnProperty.call(a, "orientation") &&
                        b.uint32(24).int32(a.orientation);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.DeviceRotationEvent();
                        a.pos < c;
                  ...
                  a.FatalErrorEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      ...
                      null != a.code &&
                        ...
                        b.uint32(10).string(a.code);
                      null != a.exception &&
                        Object.hasOwnProperty.call(a, "exception") &&
                        b.uint32(18).string(a.exception);
                      null != a.stack &&
                        Object.hasOwnProperty.call(a, "stack") &&
                        b.uint32(26).string(a.stack);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.FatalErrorEvent();
                        a.pos < c;
                  ...
                  a.HashchangeEvent = (function () {
                    ...
                    a.encode = function (a, b) {
                      b || (b = f.create());
                      null != a.hash &&
                        Object.hasOwnProperty.call(a, "hash") &&
                        b.uint32(10).string(a.hash);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.HashchangeEvent();
                        a.pos < c;
                    ...
                    a.encode = function (a, b) {
                      ...
                      if (null != a.articleMeta && a.articleMeta.length)
                        for (var c = 0; c < a.articleMeta.length; ++c)
                          g.ru.yandex.metrika.wv2.proto.ArticleMeta.encode(
                            a.articleMeta[c],
                            b.uint32(10).fork()
                          ).ldelim();
                      null != a.involvedTime &&
                        Object.hasOwnProperty.call(a, "involvedTime") &&
                        b.uint32(16).int32(a.involvedTime);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.PublishersHeader();
                        a.pos < c;
                        ...
                        switch (f >>> 3) {
                          case 1:
                            (e.articleMeta && e.articleMeta.length) ||
                              (e.articleMeta = []);
                            e.articleMeta.push(
                              g.ru.yandex.metrika.wv2.proto.ArticleMeta.decode(
                                a,
                                a.uint32()
                              )
                            );
                  ...
                  a.ArticleMeta = (function () {
                    ...
                    a.encode = function (a, b) {
                      ...
                      null != a.width &&
                        Object.hasOwnProperty.call(a, "width") &&
                        b.uint32(32).int32(a.width);
                      null != a.height &&
                        Object.hasOwnProperty.call(a, "height") &&
                        b.uint32(40).int32(a.height);
                      null != a.involvedTime &&
                        Object.hasOwnProperty.call(a, "involvedTime") &&
                        b.uint32(48).int32(a.involvedTime);
                      null != a.maxScrolled &&
                        Object.hasOwnProperty.call(a, "maxScrolled") &&
                        b.uint32(61)["float"](a.maxScrolled);
                      null != a.chars &&
                        Object.hasOwnProperty.call(a, "chars") &&
                        b.uint32(64).int32(a.chars);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.ArticleMeta();
                        a.pos < c;
                  ...
                  a.ArticleInfo = (function () {
                    ...
                    a.encode = function (a, b) {
                      ...
                      null != a.pageUrlCanonical &&
                        Object.hasOwnProperty.call(a, "pageUrlCanonical") &&
                        b.uint32(18).string(a.pageUrlCanonical);
                      null != a.pageTitle &&
                        Object.hasOwnProperty.call(a, "pageTitle") &&
                        b.uint32(26).string(a.pageTitle);
                      if (null != a.authors && a.authors.length)
                        for (var c = 0; c < a.authors.length; ++c)
                          g.ru.yandex.metrika.wv2.proto.ArticleAuthor.encode(
                            a.authors[c],
                            b.uint32(34).fork()
                          ).ldelim();
                      if (null != a.topics && a.topics.length)
                        for (c = 0; c < a.topics.length; ++c)
                          g.ru.yandex.metrika.wv2.proto.ArticleTopic.encode(
                            a.topics[c],
                            b.uint32(42).fork()
                          ).ldelim();
                      null != a.publicationDate &&
                        Object.hasOwnProperty.call(a, "publicationDate") &&
                        b.uint32(50).string(a.publicationDate);
                      null != a.chars &&
                        Object.hasOwnProperty.call(a, "chars") &&
                        b.uint32(56).int32(a.chars);
                      if (null != a.rubric && a.rubric.length)
                        for (c = 0; c < a.rubric.length; ++c)
                          g.ru.yandex.metrika.wv2.proto.ArticleRubric.encode(
                            a.rubric[c],
                            b.uint32(66).fork()
                          ).ldelim();
                      null != a.updateDate &&
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.ArticleInfo();
                        a.pos < c;
                        ...
                        switch (f >>> 3) {
                          ...
                          case 4:
                            ...
                            e.authors.push(
                              g.ru.yandex.metrika.wv2.proto.ArticleAuthor.decode(
                                a,
                                a.uint32()
                              )
                            );
                          ...
                          case 5:
                            ...
                            e.topics.push(
                              g.ru.yandex.metrika.wv2.proto.ArticleTopic.decode(
                                a,
                                a.uint32()
                              )
                            );
                          ...
                          case 8:
                            ...
                            e.rubric.push(
                              g.ru.yandex.metrika.wv2.proto.ArticleRubric.decode(
                                a,
                                a.uint32()
                              )
                            );
                  ...
                  a.ArticleAuthor = (function () {
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.ArticleAuthor();
                        a.pos < c;
                  ...
                  a.ArticleTopic = (function () {
                    ...
                    a.decode = function (a, b) {
                      ...
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.ArticleTopic();
                        a.pos < c;
                  ...
                  a.ArticleRubric = (function () {
                    ...
                    a.encode = function (a, b) {
                      ...
                      null != a.name &&
                        ...
                        b.uint32(10).string(a.name);
                      null != a.position &&
                        Object.hasOwnProperty.call(a, "position") &&
                        b.uint32(16).int32(a.position);
                      return b;
                    };
                    a.decode = function (a, b) {
                      a instanceof d || (a = d.create(a));
                      for (
                        var c = void 0 === b ? a.len : a.pos + b,
                          e = new g.ru.yandex.metrika.wv2.proto.ArticleRubric();
                        a.pos < c;
  ...
  try {
    var bb = {
        ScrollEvent: { type: K.ScrollEvent, events: ["scroll"] },
        SelectionEvent: { type: K.SelectionEvent, events: ["selection"] },
        ChangeEvent: { type: K.ChangeEvent, events: ["change", "input"] },
        MethodEvent: {
          type: K.MethodEvent,
          repeated: "args",
        ...
        ZoomEvent: { type: K.ZoomEvent, events: ["zoom"] },
        ResizeEvent: { type: K.ResizeEvent, events: ["resize"] },
        WindowEvent: {
          type: K.WindowEvent,
        ...
        FatalErrorEvent: { type: K.FatalErrorEvent, events: ["fatalError"] },
        TouchEvent: {
          type: K.TouchEvent,
          repeated: "touches",
          events: [
        ...
        eventSerialize: function (a) {
          ...
          if (d)
            return (
              d.repeated
                ? ((c = new d.type()),
                  (c[d.repeated] = a.meta[d.repeated] || a.meta))
                : (c = new d.type(this.nullToStr(a.meta))),
              (b = new K.Event({
  ...
  var Cb = Wa.inherit({
      ...
      mergeData: function (a, b) {
        (b.data && 0 === b.data.size) ||
          (this.serializer.appendBuffer(a, b), (this._dataSize = 0));
      },
      _getSize: function (a) {
        return a.length;
      },
        ...
        if (!this.totalSendLimit || this._totalSendedSize < this.totalSendLimit)
          if (
            ...
            this._data &&
              ...
              d
                ? ((c = this.serializer.toTransport(g, "Wrapper")),
                  this.sendEncoded(c, l, g, !0, { id: a, data: b }))
        ...
        this.wrappers.length &&
          (b += h.reduce(
            function (b, d) {
              var c = d.getBufferData();
              return c
                ? (b += a.serializer.serialize(c.type, c.data, !0).length)
                : b;
            },
            b,
            this.wrappers
    ...
    T = {};
  T._cookie = new N({ onlyCurrentDomain: !0 });
  T._check = D(function () {
    return (
      -1 < m.location.href.indexOf("_ym_debug\x3d1") ||
      m._ym_debug ||
  ...
  T.enabled = T._check();
  T.log = D(function () {
    (-1 < L.href.indexOf("_ym_debug\x3d1") || m._ym_debug) &&
  ...
  v.closest = function (a, b) {
    ...
    if (
      ...
      h.isNativeFunction(m.Element.prototype.closest, "closest")
    )
      return a.closest(b);
    if (
      m.Element.prototype.matches &&
      h.isNativeFunction(m.Element.prototype.matches, "matches")
    ) {
      do {
    ...
    if (
      ...
      do for (c = d.length; 0 <= --c && d.item(c) !== a; ) a;
      while (0 > c && (a = a.parentElement));
      return a;
    }
    return null;
  };
  var C = {
      ...
      getDate: function (a) {
        return a
          ? a.attributes && a.attributes.datetime
            ? "" + a.attributes.datetime.value
            : this.getVal(a)
          : "";
      },
    },
    ...
    cb = J.inherit({
      ...
      _postprocessData: function (a, b) {
        ...
        a.pageUrlCanonical ||
          (a.pageUrlCanonical = C.looksLikeFullUrl(a.id)
            ? a.id
      ...
      contentSizeWarning: function (a) {
        -1 === h.arrayIndexOf(this.alreadyWarned, a.id) &&
          (T.log(
      ...
      findContent: function () {
        var a,
          ...
          c = [],
          d,
          f = this._findContentDescriptionNodes(),
          l = this;
        for (a = 0; a < f.length; a++)
          if (
            (d = this._getContentData({
              element: f[a],
            ...
            h.isArray(d) || (d = [d]),
              h.map(function (a) {
                a &&
                  (a.chars <= Ea[a.type]
                    ? l.contentSizeWarning(a)
                    : (a = h.mixin({ sended: !1, involvedTime: 0 }, a)) &&
                      !h.inArray(c, a.id) &&
                      ((a.index = b.push(a)), c.push(a.id)));
              }, d);
        return b;
      },
    });
  ...
  var pb = cb.inherit({
      ...
      typesRegExp: new RegExp(
        "schema.org\\/(" + h.keys(cb.prototype.typesMap).join("|") + ")$"
      ),
      fields: {
        node: function (a) {
        ...
        id: function (a) {
          ...
          return b
            ? C.getVal(b)
            : (b = C.selectPropOne(a, "mainEntityOfPage")) &&
        ...
        rubric: function (a) {
          ...
          (a = C.selectOne(
            a.element,
            '[itemtype$\x3d"schema.org/BreadcrumbList"]'
          )) ||
            (a = C.selectOne(
              this.root,
              '[itemtype$\x3d"schema.org/BreadcrumbList"]'
          ...
          a &&
            ((a = C.selectProp(a, "itemListElement")),
            (b = h.map(function (a) {
              return {
        ...
        updateDate: function (a) {
          return (a = C.selectPropOne(a.element, "dateModified"))
            ? C.getDate(a)
            : "";
        },
        publicationDate: function (a) {
          return (a = C.selectPropOne(a.element, "datePublished"))
            ? C.getDate(a)
            : "";
        },
        ...
        pageTitle: function (a) {
          ...
          d && (b += C.getVal(d));
          (d = C.selectPropOne(c, "alternativeHeadline")) &&
            (b += " " + C.getVal(d));
          "" === b &&
            ((d = C.selectPropOne(c, "name")) ||
              (d = C.selectPropOne(c, "itemReviewed")),
            d && (b += C.getVal(d)));
          3 === a.type &&
            (a = C.closest(c, '[itemtype$\x3d"schema.org/Question"]')) &&
            (d = C.selectPropOne(a, "text")) &&
            (b += C.getVal(d));
          return b;
        },
        authors: function (a) {
          ...
          return (b = h.map(function (a) {
            var b = {},
              c;
            C.testAttr(a, "itemtype", /.+schema.org\/(Person|Organization)/) &&
              (c = C.selectPropOne(a, "name")) &&
              (b.name = C.getVal(c));
            b.name ||
              (b.name =
      ...
      _getContentData: function (a) {
        return a.element && a.element.innerText && a.element.innerText.length
          ? pb.superclass._getContentData.call(this, a)
          : null;
      },
    ...
    db = cb.inherit({
      id: "j",
      dataNodesSelector:
        'script[type\x3d"application/ld+json"],script[type\x3d"application/json+ld"],script[type\x3d"ld+json"],script[type\x3d"json+ld"]',
      isAuthorsInTitle: !0,
      fields: {
        node: function (a) {
          return this._getContentNode(a);
        ...
        chars: function (a) {
          return "string" === typeof a.data.text
            ? a.data.text.length
            : this._getContentNode(a).innerText.length;
        },
        authors: function (a) {
          var b = [];
          b = b.concat(this._extractArrayField(a.data, "author", ["name"]));
          b = b.concat(
            this._extractArrayField(a.data.mainEntity, "author", ["name"])
          );
          return b.concat(
            this._extractArrayField(a.data.mainEntityOfPage, "author", ["name"])
          );
        },
        pageTitle: function (a) {
          ...
          "" === b &&
            (a.data.name
              ? (b = a.data.name)
              : a.data.itemReviewed && (b = a.data.itemReviewed));
        ...
        topics: function (a) {
          return this._extractArrayField(a.data, "about", [
            "name",
            "alternateName",
          ]);
        },
        rubric: function (a) {
          ...
          h.map(function (a) {
            ...
            h.toArray(
              C.select(
                t.body === b ? t.documentElement : b,
                this.dataNodesSelector
              )
            )
          ));
          return c.length && ((c = c[0].itemListElement), h.isArray(c))
            ? h.filter(
                Boolean,
                h.map(function (a) {
                  return a.item && !isNaN(a.position)
                    ? { name: a.item.name || a.name, position: a.position }
                    : null;
                }, c)
              )
            : [];
      ...
      _getContentNode: function (a) {
        ...
        !d &&
          c &&
          "string" === typeof c &&
          (d = this._extractElementByHashedUrl(c));
        return d
          ? d
          : C.closest(b, "head") || 0 === f.innerText.length
          ? m.document.body
          : f;
      },
      ...
      _getContentData: function (a) {
        ...
        if (
          !a.data &&
          ((a.data = aa.parse(b.innerText)),
          !a.data ||
            (!/schema\.org/.test(a.data["@context"]) && !h.isArray(a.data)))
        )
          return null;
        if ((d = this._getGraph(a.data)))
          return h.map(function (a) {
        ...
        "QAPage" === a.data["@type"] &&
          (f = a.data.mainEntity || a.data.mainEntityOfPage);
        ...
        return (d = db.superclass._getContentData.call(
          this,
          h.mixin(a, { type: d })
        ));
      },
      ...
      _getGraph: function (a) {
        return (
          (h.isArray(a) && a) || (a && h.isArray(a["@graph"]) && a["@graph"])
        );
      },
    }),
    Db = cb.inherit({
      ...
      _getEntityData: function (a) {
        ...
        return h.inArray(this.schemaEntities.opengraph, f.type)
          ? h.mixin(a, { data: f })
          : null;
      },
      _getContentNode: function (a) {
      ...
      _getContentData: function (a) {
        return (a = this._getEntityData(a))
          ? Db.superclass._getContentData.call(this, a)
          : null;
      },
    }),
    oc = J.inherit({
      ...
      isStopped: !1,
      schemas: { json_ld: db, schema: pb, microdata: pb, opengraph: Db },
      checkSize: function () {
        var a = this,
        ...
        c.push(function (b) {
          !a.isStopped &&
            b.length &&
            (a.findContent(b), (a.meta = a.getMeta()), a.send());
        });
      ...
      getMeta: function () {
        ...
        var c = h.map(function (c) {
          if (a.isRemovedFromDoc(c.element)) {
            var d = null;
            b.push(c);
          } else (d = { id: c.id, involvedTime: Math.max(c.involvedTime, 0), maxScrolled: c.maxScrolled || 0, chars: c.update ? c.update("chars") : 0 }), c.node && h.isFunction(c.node.getBoundingClientRect) && ((c = c.node.getBoundingClientRect()), (d.x = Math.round(c.left) + a.scroll.x), (d.y = Math.round(c.top) + a.scroll.y), (d.width = Math.round(c.width)), (d.height = Math.round(c.height)));
          return d;
        }, this.articles);
        h.map(function (b) {
      ...
      send: function () {
        ...
        a.length &&
          (this.push({ articleInfo: a }),
          T.log("Publisher content info found:", a),
      ...
      start: function (a) {
        ...
        a &&
        a.schema &&
        this.schemas[a.schema] &&
        m.document &&
        h.isNativeFunction(m.document.querySelectorAll, "querySelectorAll")
          ? (this.globalConfig.setSafe("pai", function () {
            ...
            T.log('Publishers analytics schema "' + a.schema + '"'),
            this.checkSize())
          : this.stop();
      },
      push: function (a) {
              ...
              function (a) {
                ...
                var c = Math.max(
                  (Math.min(
                    ...
                    Math.max(this.scroll.y, b.y)) /
                    this.viewbox.height,
                  0
                );
                var f = Math.max(
                  (this.scroll.y + this.viewbox.height - b.y) / b.height,
                  0
                );
    ...
    Eb = J.inherit({
      ...
      _getBufferType: function () {
        ...
        if (!T.enabled && Bb) {
          try {
            b =
              (b = 2 === new Blob(["\u00e4"]).size) &&
              2 === new Blob([new m.Uint8Array([1, 2])]).size;
          } catch (c) {}
      ...
      _initComponent: D(function () {
        ...
        this._localStorage = new S({ counterId: this.counterId });
        ...
        this._eventsBuffer = new a(
          h.mixin(c, b && { browserInfoMix: { pai: b } })
        );
        this._localStorage.remove("pai");
        this._buffer.activate();
        this._eventsBuffer.activate();
        "b" !== d &&
          ((this._formRecorder = new Sb(
            this.protocol,
            this.counterId,
            this.counterType,
            this.hid,
      ...
      start: D(function (a, b) {
        ...
        if (this._recorder) {
          ...
          "w" === d && this.isEnabled() && this._isCorrectCounter()
            ? (this._recorder.middleware(function (a) {
                c.send(a.data);
              }),
              this._recorder.init(),
          ...
          this._publisher &&
            ...
            this._eventsBuffer.setWVType(this._buffer instanceof Cb ? 5 : 4),
      ...
      send: function (a, b) {
        ...
        h.forEachKey(
          ...
          function (a, f) {
            ...
            if (d) {
              var m = d.name;
              h.inArray(["event", "articleInfo"], m) &&
                (g = this._eventsBuffer);
              d.iterate
                ? h.forEachKey(
                    f,
                    function (a, d) {
      ...
      _getStorage: function () {
        this._storage || (this._storage = new N({ counterId: this.counterId }));
    ...
    Fb = {
      ...
      handle: function (a) {
        ...
        "init" == d
          ? ((d = "yaCounter" + c),
            m[d] ||
              ((a = h.mixin(a[2] || {}, { id: +c })),
              (m[d] = new m.Ya[this.constructorName](a))))
          : h.inArray(this.counters, b) && f && f[d]
          ? ((a = [].slice.call(a, 2)), f[d].apply(f, a))
          : h.inArray(this.counters, b) ||
            (this.waitPool[b] || (this.waitPool[b] = []),
      ...
      subscribe: function (a) {
        a &&
          ...
          this.waitPool[a] &&
            (h.arrayEvery(this.waitPool[a], this.handle, this),
    ...
    qb = Ra.inherit({
      ...
      _initComponent: function () {
        ...
        this._ilStorage = new S({ counterId: this.counterId });
      },
      postParams: [],
      ...
      sendHit: function (a) {
        ...
        c &&
          ...
          (b.ilt = ja.encode(Qa.encode(h.trim(c, Hb)))));
          ...
          : (this.globalConfig.set("fakeHit", function (a) {
            ...
            this._getSender().sendHit({
              ...
              callback: function (b, d) {
                var l = b || {};
                f = { time: x.getMs(), params: l, bkParams: d };
    ...
    Jb = J.inherit({
      ...
      baseTld: "ru",
      partners: {
        "mc.edadeal.ru": { regex: /^([^/]+\.)?edadeal\.ru$/, tld: "ru" },
        "mc.yandexsport.ru": {
      ...
      _initComponent: function () {
        ...
        this.syncTlds = h.reduce(
          function (a, c) {
            return c(a);
          },
          yb,
          [
            h.bind(h.filter, null, function (b) {
              return b !== a.baseTld;
            }),
            h.bind(
              h.reduce,
        ...
        h.forEachKey(
          this.partners,
          function (a, c) {
            c.regex.test(m.location.hostname) &&
      ...
      sync: function (a) {
        var b = this,
          c =
            -1 !=
            M().hostname.search(
              /(?:^|\.)(?:ya|yandex(sport)?|beru|kinopoisk|edadeal)\.(?:\w+|com?\.\w+)$/
            ),
          d = c ? this._need(1) : !1;
        if (!c || u.isIframe() || u.isITPSafari()) return a();
        this._is()
          ? a()
          : d
          ? (this._setStatus(!0),
            b._getCn().hit(function () {
              c && b._syncAdmetrica();
              b._sync(d, a);
            }))
          : a();
      ...
      _need: function (a) {
        var b = this._getDomainByLang(),
          ...
          d = [];
        1 === a &&
          ((a = this.syncTlds[c]) && d.push.apply(d, a),
          (a = this.syncTlds[b]),
          b !== c && a && d.push.apply(d, a));
      ...
      _syncAdmetrica: function () {
        var a = new Ca({}),
          b = this._getLs();
        ((b.get("synced") || {}).SYNCED_ADM || 1) + 1440 < x.getMinutes() &&
          a.request(
        ...
        if (0 < f) {
          ...
          for (c = 0; c < f; c++)
            (function (a) {
              r.request(
                "https://" +
                  (h._replaceBase[a] ? a : h.baseUrl + a) +
      ...
      _getCn: function () {
        this._cn ||
          (this._cn = new Ib({ fake: !0, globalConfig: this.globalConfig }));
        return this._cn;
      },
      _getLs: function () {
  ...
  var qc = function (a, b) {
    ...
    rc = function (a, b) {
      0 === parseFloat(a.c_recp) &&
        (Kb(b), b.s.set("ymoo" + b.k, x.getMinutes()));
    },
    sc = function (a) {
      var b = x.getMinutes(),
        c;
  ...
  var Sa = {
      ...
      save: function (a, b) {
        this._getReq().request(
          this._url + wa.stringify({ key: a, value: h.toJSON(b) })
        );
        this._getLs().set(a, b);
      },
      get: function (a) {
    ...
    uc = {
      sync: D(function (a, b, c, d) {
        ...
        if (this._enabled(a, b, c)) {
          this._setStatus(!0);
          var h = new tc({ method: "GET", withCredentials: !1 });
      ...
      _save: function (a, b, c) {
        ...
        a
          ? new Ra({
              ...
              sendTitle: !1,
              fake: !0,
            }).sendDevice({ data: h.trim(b), port: c })
          : (d -= 45);
        Sa.save("ds", d);
      },
      _is: function () {
      ...
      _enabled: function (a, b, c) {
        ...
        if (
          !(60 < x.getMinutes() - Sa.getNum("ds")) ||
          this._is() ||
          h.isDev(this.globalConfig)
        )
          return !1;
        0 === b && 67993306 === a && (d = 1);
        a =
  ...
  U.dispatchCustomEvent = D(function (a, b) {
    var c;
    b = b || t;
    if ((c = h.getNativeFunction("createEvent", t)("Event")))
      c.initEvent(a, !1, !1), h.getNativeFunction("dispatchEvent", b)(c);
  }, "evt.dispatch");
  var $a = { lastReferrer: null };
  u.isSearchRobot = h.memorize(function () {
    return new RegExp(
      "(" +
        "yandex.com/bots|Googlebot|APIs-Google|Mediapartners-Google|AdsBot-Google|FeedFetcher-Google|Google-Read-Aloud|DuplexWeb-Google|Google Favicon|googleweblight|Mail.RU_Bot|StackRambler|Slurp|msnbot|bingbot|www.baidu.com/search/spi_?der.htm".replace(
          /[./]/g,
          "\\$\x26"
        ) +
        ")"
    ).test(m.navigator.userAgent);
  });
  var Ia = J.inherit({
    counter: null,
    prefsEcommerce: null,
    ...
    initUserLayer: function () {
      ...
      if (this.prefsEcommerce || this.prefsUseDataLayer)
        this._overridePush(this.prefsEcommerce) ||
          (h.isString(this.prefsEcommerce) &&
    ...
    _tryTimeout: function () {
      this._overridePush(m[this.dataLayerName]) ||
        (this.overrideTimeout = h.setTimeout(
          this._tryTimeout,
          1e3,
          "dlObserver"
        ));
    ...
    _callHandlers: function (a) {
      h.arrayEvery(Ia.handlers, function (b) {
        b &&
          b.type &&
          h.arrayEvery(b.type.split(","), function (c) {
        ...
        if ((d = a[l]) && d.ymetrikaEvent) {
          ...
          if ("params" === g.type && g.data) {
            ...
            g.status == this.status.NEW &&
              g.parent &&
              this.frameConnector &&
              this.frameConnector.checkFrame(m.parent) &&
              m.parent !== m &&
              (this.frameConnector.sendToParents(
                { type: "params", data: g.data },
                function () {
  ...
  var xa = ["0", "1", "2", "3"],
    ...
    la = J.inherit({
      ...
      parseValue: function (a) {
        a = h.inArray(["GDPR-ok-view-default", "GDPR-ok-view-detailed"], a)
          ? "0"
          : a.replace("GDPR-ok-view-detailed-", "");
      ...
      accept: function (a, b, c, d) {
        ...
        f &&
          (this.setGdprCookie(c, f),
          this._sender.updateCookies(),
          this.realise(a, b),
          this.frameConnector.sendToChildren({ type: d }));
      },
      getPopupOkEvents: function () {
        return ["GDPR-ok-view-default", "GDPR-ok-view-detailed"].concat(
          h.map(function (a) {
      ...
      showPopup: function (a, b, c, d) {
        ...
        a.onerror = function (a) {
          ...
          f.realise(b, c);
          f.frameConnector.sendToChildren({ type: "GDPR-ok-view-default" });
        };
        a.onload = function () {
      ...
      handleGdprValue: function (a, b, c) {
        ...
        if (a || l || d.enabled)
          if (
            (f.create("gdpr_popup", Lb),
            d.frameConnector &&
              d.frameConnector.addHandler("isYandex", function () {
                return { type: "isYandex", isYandex: pa() };
              }),
            d.frameConnector.isIframe)
          ) {
            d.frameConnector.sendToParents({ type: "isYandex" }, function (
              a,
              c
            ) {
              var g = !1;
              clearTimeout(r);
              c[0].isYandex
                ? (d.trigger("GDPR-frame-ya"),
                  h.map(function (a) {
                    d.frameConnector.addHandler(a, function () {
                      var h = d.parseValue(a);
                      g ||
                        (h && (d.setGdprCookie(f, h), d.realise(c, b)),
                        (g = !0));
                    });
                  }, d.getPopupOkEvents()))
                : (d.trigger("GDPR-frame-noya"), d.realise(c, b));
            });
            var r = h.setTimeout(function () {
              d.trigger("GDPR-frame-skip");
              d.realise(c, b);
            }, 2e3);
          } else d.askGDPR(g, m, c, b, f);
        else
          return (
            a || (f.create("gdpr", "0"), d.trigger("GDPR-eu-skip")),
            d.realise(c, b)
          );
      },
      handle: function () {
        ...
        if (
          ...
          (h.inArray(xa, d) ||
            u.isSafariWebView() ||
            u.isAndroidWebView() ||
            h.inArray(wc, m.location.href.split("?")[0]) ||
            !pa() ||
            c.read("yandex_login") ||
            this.disable ||
            n)
          ...
          return (
            c.read("yandex_login")
              ? (this.trigger("GDPR-skip-login"), c.create("gdpr", "0", 525600))
              : pa()
              ? d
                ? d === Lb
                  ? this.trigger("GDPR-cookie-fail")
                  : this.trigger("GDPR-cookie-success")
                : u.isSafariWebView() || u.isAndroidWebView()
        ...
        this.globalConfig.set(this.globalKey, function (a, c) {
          ...
          b.size + d < f.MAX_SIZE
            ? (b.push(a), (b.size += d))
            : h.warning("GDPR buffer is exceeded");
        });
        a.hit(function (a) {
          f.handleGdprValue(a.params.eu, b, g);
        });
      },
    });
  la.globalKey = "f1";
  la.cookie = new N({ skipPrefix: !0 });
  la.getState = function (a) {
    var b = la.cookie.read("gdpr");
    a = h.reduce(
      function (a, b) {
        b.ymetrikaEvent &&
          h.inArray(Mb, b.ymetrikaEvent.type) &&
          a.push(h.arrayIndexOf(Mb, b.ymetrikaEvent.type));
        return a;
      },
      [],
      a.get("dataLayer")
    ...
    return a.length
      ? ((a = a.join(",")), b && (a += "-" + (h.inArray(xa, b) ? b : "")), a)
      : "";
  };
  ...
  u.isPrivate = D(function (a) {
    ...
    a = h.bind(a, null, 1);
    if (h.isFunction(m.webkitRequestFileSystem) && !u.isAndroid())
      return m.webkitRequestFileSystem(0, 0, b, a);
    if (u.isFF())
      return "undefined" == typeof navigator.serviceWorker ? a() : b();
    if (u.isSafari() && h.isFunction(m.openDatabase))
      try {
  ...
  u.getHref = function (a) {
    ...
    return h.isString(a)
      ? "" + a
      : "[object SVGAnimatedString]" === h.toString(a)
      ? "" + a.baseVal
      : "";
  };
  ...
  v.getElementPath = function (a) {
    for (
      ...
      (b += c[a.tagName] || "*"),
        (b += v.getElementNeighborPosition(a) || ""),
        (a = a.parentNode);
    ...
    zc = J.inherit({
      ...
      _initComponent: function () {
        ...
        if (this.ignoreTags)
          for (a = 0; a < this.ignoreTags.length; a++)
            this.ignoreTags[a] &&
              h.mergeArrays(this._ignoreTags, [
      ...
      _handler: function (a) {
        ...
        if (this._isTrackingClick(a)) {
          ...
          c = M().href;
          this.isTrackHash
            ? h.mergeArrays(b, ["wh", "1"])
            : (c = c.split("#")[0]);
          this._sender.sendClick(h.trim(c, mb), b.join(":"));
          this._lastClick = a;
        }
      },
    ...
    Nb = J.inherit({
      ...
      checkAssessor: function () {
        ...
        h.forEachKey(
          ...
          function (c) {
            if (
              new RegExp(c).test(m.location.hash) ||
              N.get(this.ASSESSOR_COOKIE + c)
            )
              N.set(this.ASSESSOR_COOKIE + c), a.push(b[c]);
          },
          this
        );
        return a;
      ...
      _initComponent: function () {
        ...
        this.globalConfig.get(this.REMOTE_CONTROL) ||
          ...
          (this._executedMsgs = {}),
          w.on(m, "message", this._onMessage, this),
          a.length &&
            (this.globalConfig.set("oo", !0),
            this.globalConfig.get("stopRecoder", function () {})(),
            h.arrayEvery(a, function (a) {
              v.loadScript({ src: a }, m);
              return 1;
            })));
      },
      _buildRemoteIframe: function (a) {
        ...
        if (c) {
          ...
          var d = b.firstChild;
          d.onload = function () {
            v.loadScript({ src: a }, d.contentWindow);
          };
          ...
          b.createShadowRoot || b.webkitCreateShadowRoot
            ? (c.appendChild(b),
              ...
              (m._ym__remoteIframeContainer = b))
            : (c.appendChild(d), (m._ym__remoteIframeContainer = d));
        }
      },
      _isAllowedOrigin: function (a) {
        return (
          /^http:\/\/([\w\-.]+\.)?webvisor\.com\/?$/.test(a) ||
          /^https:\/\/([\w\-.]+\.)?metri[kc]a\.yandex\.(ru|ua|by|kz|com|com\.tr)\/?$/.test(
            a
          )
        );
      },
      _isAllowedResource: function (a) {
        return /^https:\/\/(yastatic\.net\/s3\/metrika|s3\.mds\.yandex\.net\/internal-metrika-betas|[\w-]+\.dev\.webvisor\.com|[\w-]+\.dev.metrika.yandex.ru)\/(\w|-|\/|(\.)(?!\.))+\.js$/.test(
          a
        );
      },
      _onMessage: function (a) {
        ...
        d &&
          this._isAllowedOrigin(d) &&
          (d = aa.parse(a.data)) &&
          "appendremote" === d.action &&
          !this._executedMsgs[d.id] &&
          this._isAllowedResource(d.resource) &&
          (d.inline ? (c = d.resource) : (b = d.resource),
          b &&
            ((this._executedMsgs[d.id] = !0),
            (m._ym__postMessageEvent = a),
            (m._ym__inpageMode = d.inpageMode),
            (m._ym__initMessage = d.initMessage),
            this._buildRemoteIframe(b)),
          c && ((this._executedMsgs[d.id] = !0), v.loadScript({ src: c }, m)));
      },
    }),
    Ac = {
      key: "ssp",
          ...
          w.ready(function () {
            var a = this,
              b = [
                ...
                "https://dmp.adform.net/serving/cookie/match?party\x3d1123",
              ],
              c = !0;
            h.hiddenFrameCreate(
            ...
            var d = function (a) {
              if (a.data && a.data.split) {
                ...
                "sc.frame" === d[0] && c
                  ? ((c = !1),
                    h.clearTimeout(l),
                    a.source.postMessage("sc.images*" + b.join("*"), "*"))
                  : "sc.image" === d[0] &&
                    1 < d.length &&
                    d[1] &&
                    ((b = h.arrayFilter(
                    ...
                    b.length || (Sa.save("cm", x.getMinutes()), f()));
              }
            };
            var f = function () {
              w.un(m, "message", d, a, { passive: !1 });
              h.hiddenFrameRemove(
                "https://mc.yandex.ru/metrika/watch_match.html",
                a.key
              );
            ...
            w.on(m, "message", d, this, { passive: !1 });
          });
      },
      enabled: function () {
        ...
        4: function (a, b, c) {
          ...
          b.detectAd = function () {
            ...
            g.windowsTreeEach(t, function (a) {
              ...
              v.push({ windowsTree: a, adElements: e });
            });
            v.forEach(function (a) {
              a.adElements = a.adElements.sort(function (a, b) {
                return (
                  h.getParentElementsCount(a.element) -
                  h.getParentElementsCount(b.element)
                );
              });
            });
            var u = [],
            ...
            v.forEach(function (a) {
              ...
              a.forEach(function (a) {
                var b = a.element;
                w.push({ provider: a.provider, element: c ? e : b });
              });
            });
        ...
        9: function (a, b, c) {
          ...
          b.getAdsInWindow = function (a, b) {
            ...
            var g = b.isInIFrame,
              ...
              e = [],
              t = [],
              v = d.listToArray(h.querySelectorAll("yatag")),
              u = d.listToArray(h.querySelectorAll("yatag yatag"));
            c(
              "yandex",
              v.filter(function (a) {
  ...
  var Bc = {
      init: function (a, b) {
        if (Math.random() < (b || 0.005) && !E.get("adDetect")) {
          E.set("adDetect", !0);
          var c = function (b) {
    ...
    Ob = J.inherit({
      ...
      checkChildrenData: function (a, b) {
        h.arrayEvery(
          ...
          function (c) {
            -1 == h.arrayIndexOf(c.tryTo, b.counterId) &&
              (c.tryTo.push(b.counterId),
              h.mixin(c.data, { toCounter: b.counterId }),
      ...
      genMessage: function (a, b) {
        var c = { date: x.getMs(), key: Math.random(), dir: 0 };
        ...
        return { meta: c, string: aa.stringify(d) };
      },
      ...
      sendToChildren: function (a, b, c) {
        ...
        h.keys(this.childs).length &&
          h.forEachKey(
            this.childs,
            function (b) {
              this.sendToIframe(
                d.childs[b].window,
                h.mixin(a, { toCounter: b }),
                function (a) {
      ...
      destruct: function () {
        w.un(m, "message", this.onMessage, this, {
          passive: !1,
          name: "FrameConnector",
        });
      ...
      _initComponent: function () {
        ...
        if (this.message) {
          ...
          this.isIframe &&
            this.sendToIframe(m.parent, { type: "initToParent" }, function (a) {
          ...
          if (
            ...
            if (!d.toCounter || d.toCounter == this.counterId) {
              ...
              d.counterId &&
                ...
                ((l = this.trigger(d.type, a, d)),
                a.source.postMessage(
                  this.genMessage(l, [b[0], b[1], d.counterId]).string,
                  "*"
                ));
            }
          } else
    ...
    Pb = { id: "i", name: "n", path: "p" },
    Qb = { id: 100, name: 100, path: 500 },
    Ja = J.inherit({
      awaitSubmitForms: [],
      _initComponent: D(function () {
        T.log("Form goal. Counter " + this.counterId + ". Init.");
        w.on(m, "submit", this.onSubmit, this, { capture: !0, passive: !0 });
        w.on(m, "click", this.onClick, this, { capture: !0, passive: !0 });
      ...
      onClick: D(function (a) {
        a = v.closest(a.target, "button,input");
        var b = this,
          c;
        "submit" === (a && a.type) &&
          (c = v.closest(a, "form")) &&
          (this.awaitSubmitForms.push(c),
          h.setTimeout(
            D(function () {
  ...
  Ja.init = D(
    function () {
      if (!Ja.inited) {
        var a = new Ka({ counterId: 65446441 });
        new Ja({
          cb: function (b) {
  ...
  E.init()
    ...
    .setSafe("dataLayer", [])
    .setSafe("hitId", h.random(1, 1073741824))
    .setSafe("_globalMetrikaHitId", h.random())
    .setSafe("v", ya);
  Da.globalConfig = E;
  ka = "Metrika2";
    ...
    return D(function () {
      function l(a, b, c) {
        ...
        if (a) {
              ...
              for (e = 0; e < d.length; e++) {
                ...
                if ("ref" == f.type) var k = g(f);
                  ...
                  for (u = 0; u < oa.length; u++)
                    w["utm_" + oa[u]] && (x[oa[u]] = w["utm_" + oa[u]]);
                  w = x;
                  ...
                  if (!u && !f.yandex_direct && q && q.length)
          ...
          d = b.read("mp2_track");
          a = a.substs && a.substs[d];
          d && a
            ? (b.create("mp2_substs", h.toJSON(a)),
              (a = n(a)),
              c.params("__ym", a ? "mp_trackid" : "mp_trackid_bad", d))
            : r();
        } else r();
      }
      function g(a) {
        ...
        for (c = 0; c < e.length; c++) {
          ...
          if (b.match(f))
            if (((f = a.params || []), f.length)) {
              var g = h.safeDecodeURIComponent(
      ...
      function y(a, b) {
        ...
        for (c = 0; c < g.length; c++) {
          ...
          for (e = 0; e < k.length; e++)
            (f = k[e].split("\x3d")), "_openstat" === f[0] && (d = f[1]);
        }
        d &&
          (d =
            -1 < d.indexOf(";")
      ...
      function C() {
        var g = !1,
          n = !1;
        Ca || ((n = W.initCookie(za)), (Da.userInfo = W._userID), zb.init(E));
        Da.initPU(ia, E);
          ...
          var p = function (e) {
            ...
            g.sendHit({
              ...
              callback: function (g, k) {
                ...
                f.isDestructing() ||
                  (ma.start(g.webvisor, g.publisher),
                  l(g.mp2, a, f),
                  w.on(m, "load", f.replacePhones, f));
                (g.form_goals ||
                  -1 < m.location.href.indexOf("yagoalsforms\x3d1")) &&
                  new Ja({
                    counterId: a,
                    cb: function (a) {
                      R.sendForm(a, { url: G.url ? P : M().href });
                    },
                  });
                f._inited = !0;
                e && e();
        ...
        k(!1);
        w.on(t, "click", e, null, { name: "extLinkClick" });
        0 != h.keys(G).length &&
          (da && da.initUserLayer(),
          G.enableAll
            ? (k(!0), B(!0), z())
            : (G.clickmap && B(G.clickmap),
              G.trackLinks && k(G.trackLinks),
              G.accurateTrackBounce && z(G.accurateTrackBounce)),
          G.triggerEvent &&
            h.async(
              function () {
      ...
      function e(a) {
        if (f._trackLinks && f._trackLinks.on) {
          ...
          if (c && !v.classNameExists(a, "ym-disable-tracklink")) {
            ...
            var g = ub(a);
            g = c === g ? "" : g;
            if (v.classNameExists(a, "ym-external-link"))
              R.sendClickLink({ url: c, title: g, modes: d }, P);
            else {
      ...
      function H(a, b) {
        ...
        function e(a) {
          ...
          for (b = 0; b < r.length; b += 3)
            if (a) w.on(r[b], r[b + 1], r[b + 2], { name: "tabTrack" });
      ...
      if (!m["disableYaCounter" + a]) {
        ...
        var Q = E.get("hitId");
        var ia = new Ob({ counterId: a, hid: Q });
        ...
        f.replacePhones = p(function () {
          var b, c;
          try {
            (b = new N({ counterId: a }).read("mp2_substs")) &&
              (c = aa.parse(b)) &&
              n(c, !0);
          } catch (oa) {}
          return f;
        ...
        var xa = new S({ counterId: a });
        f.hit = p(function (b, c, d, e, g, k) {
          (b = b && h.isFunction(b.toString) ? b.toString() : !1)
            ? (h.isObject(c) &&
                ((d = c.referer),
                (e = c.params),
                (g = c.callback),
        ...
        f.params = p(function (b) {
          ...
          if (b) {
            ...
            (d =
              -1 !== h.arrayIndexOf(h.keys(e[0]), "__ym") && e[0].__ym.user_id)
              ? T.log('Set user id "' + e[0].__ym.user_id + '"')
              : T.log(
        ...
        f.file = p(function (b, c) {
          b
            ? ((c = c || {}),
              T.log("file. Counter " + a, ". URL: " + b, ". Params: ", c),
              R.sendFileUpload({
                url: b,
                title: c.title,
                vParams: c.params,
        ...
        f.extLink = p(function (b, c) {
          b
            ? ((c = c || {}),
              T.log("extLink. Counter " + a, ". URL: " + b, ". Params: ", c),
              R.sendExtLink(
                {
                  url: b,
                  title: c.title,
        ...
        var Fa = {
          ...
          parseValidate: function (a, b) {
            ...
            for (d in b)
              b.hasOwnProperty(d) &&
                -1 === h.arrayIndexOf(this.requiredEcommerceFields, d) &&
          ...
          validate: function (a, b) {
            ...
            if (h.isObject(b))
              switch (a) {
                ...
                case "add":
                case "remove":
                  h.isArray(b.goods) && b.goods.length
                    ? (c = h.arrayEvery(b.goods, function (a) {
                        return (
                          h.isObject(a) &&
                          (h.isString(a.id) ||
                            h.isNumber(a.id) ||
                  ...
                  break;
                case "purchase":
                  h.isNumber(b.id) || h.isString(b.id)
                    ? (c = !0)
                    : (d =
        ...
        f.userParams = p(function (a, b, c) {
          h.isObject(a)
            ...
            : h.warning("Wrong user params");
          return f;
        }, "uparams");
        f.experiments = p(function (a, b, c) {
          R.sendExperiments({ callback: b, ctx: c, experiments: a });
          return f;
        }, "exps");
        f.id = f.setUserID = p(function (a, b, c) {
          h.isString(a) || h.isNumber(a)
            ? f.params({ __ym: { user_id: a } }, b || function () {}, c)
            : h.warning("Incorrect user ID");
          return f;
        }, "id");
        var qa = new N();
        ...
        f.destruct = p(function () {
          f._isDestructing = !0;
          w.un(t, "click", e, null, { name: "extLinkClick" });
          w.un(m, "load", f.replacePhones, f);
          I(!1);
          ma && ma.stop();
          E.set("stopRecoder", A);
          E.set("counter", A);
          ...
          try {
            delete m["yaCounter" + a],
              delete E.get("counters")[V],
              delete E.get("hitParam")[V];
          } catch (sa) {}
        });
        ...
        if (a) {
          ...
          if (
            ...
            var va = function () {
              "prerender" !== t.webkitVisibilityState &&
                "prerender" !== t.visibilityState &&
                (w.un(t, "webkitvisibilitychange,visibilitychange", va), q(!0));
            };
  ...
  m.ya_cid &&
    m.Ya.Metrika &&
    new m.Ya.Metrika(m.ya_cid, m.ya_params, m.ya_class);
  m.ya_cid &&
    !m.ya_hit &&
    (m.ya_hit = function (a, b) {
  ...
  m.Ya[ka].informer = function (a) {
    ...
    b ||
      v.loadScript({ src: "https://informer.yandex.ru/metrika/informer.js" });
  };
  w.on(
    t,
    "click",
    D(function (a) {
      ...
      if (
        ...
        m.Ya[ka].informer({ i: b, id: +d, lang: c });
        U.prevent(a);
      }
    }, "adv-inf"),
    null,
